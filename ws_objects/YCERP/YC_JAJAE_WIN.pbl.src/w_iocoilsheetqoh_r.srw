$PBExportHeader$w_iocoilsheetqoh_r.srw
$PBExportComments$COILL,SHEET재고현황(2000/01/16,이인호)
forward
global type w_iocoilsheetqoh_r from w_inheritance
end type
type cbx_1 from checkbox within w_iocoilsheetqoh_r
end type
type cbx_2 from checkbox within w_iocoilsheetqoh_r
end type
type cbx_3 from checkbox within w_iocoilsheetqoh_r
end type
type cbx_4 from checkbox within w_iocoilsheetqoh_r
end type
type cbx_5 from checkbox within w_iocoilsheetqoh_r
end type
type st_1 from statictext within w_iocoilsheetqoh_r
end type
type dw_3 from datawindow within w_iocoilsheetqoh_r
end type
type cbx_6 from checkbox within w_iocoilsheetqoh_r
end type
type pb_1 from picturebutton within w_iocoilsheetqoh_r
end type
type st_8 from statictext within w_iocoilsheetqoh_r
end type
type ddlb_fld from dropdownlistbox within w_iocoilsheetqoh_r
end type
type ddlb_dwtitles from dropdownlistbox within w_iocoilsheetqoh_r
end type
type st_9 from statictext within w_iocoilsheetqoh_r
end type
type ddlb_op from dropdownlistbox within w_iocoilsheetqoh_r
end type
type sle_value from singlelineedit within w_iocoilsheetqoh_r
end type
type cb_filteron from commandbutton within w_iocoilsheetqoh_r
end type
type cb_filteroff from commandbutton within w_iocoilsheetqoh_r
end type
type cb_1 from commandbutton within w_iocoilsheetqoh_r
end type
type cb_2 from commandbutton within w_iocoilsheetqoh_r
end type
type cbx_7 from checkbox within w_iocoilsheetqoh_r
end type
type gb_4 from groupbox within w_iocoilsheetqoh_r
end type
end forward
...
integer width = 4864
integer height = 2264
string title = "코일 SHEET재고, ERP 비교(w_iocoilsheetqoh_r)"
cbx_1 cbx_1
cbx_2 cbx_2
cbx_3 cbx_3
cbx_4 cbx_4
...
global w_iocoilsheetqoh_r w_iocoilsheetqoh_r
...
if GF_Permission('코일시트재고,ERP재고 비교', gs_userid) = 'Y' then	
else
...
type pb_save from w_inheritance`pb_save within w_iocoilsheetqoh_r
boolean visible = false
integer x = 3918
integer y = 60
end type

type dw_1 from w_inheritance`dw_1 within w_iocoilsheetqoh_r
...
string dataobject = "d_iocoilsheetqoh_r"
...
type st_title from w_inheritance`st_title within w_iocoilsheetqoh_r
integer x = 32
integer y = 24
integer width = 1595
integer height = 136
string text = "코일 SHEET재고,ERP재고 비교"
end type

type st_tips from w_inheritance`st_tips within w_iocoilsheetqoh_r
end type

type pb_compute from w_inheritance`pb_compute within w_iocoilsheetqoh_r
boolean visible = false
integer x = 1669
end type

type pb_print_part from w_inheritance`pb_print_part within w_iocoilsheetqoh_r
boolean visible = false
integer x = 3986
integer y = 64
...
type pb_close from w_inheritance`pb_close within w_iocoilsheetqoh_r
integer x = 3776
integer y = 60
end type
...
type pb_print from w_inheritance`pb_print within w_iocoilsheetqoh_r
integer x = 3383
integer y = 60
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_iocoilsheetqoh_r
boolean visible = false
integer x = 2437
end type

type pb_delete from w_inheritance`pb_delete within w_iocoilsheetqoh_r
boolean visible = false
integer x = 2432
end type

type pb_insert from w_inheritance`pb_insert within w_iocoilsheetqoh_r
boolean visible = false
integer x = 2240
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_iocoilsheetqoh_r
integer x = 3191
integer y = 60
end type
...
dw_1.retrieve( is_loc, is_item, ls_oc, ls_date)
if cbx_7.checked then
	dw_1.setfilter(" gab <> 0 ")
else
	dw_1.setfilter(" a_stock_qty +  coil_stock_qty <> 0 ")
end if
...
type gb_3 from w_inheritance`gb_3 within w_iocoilsheetqoh_r
integer x = 32
integer y = 232
integer width = 4114
integer height = 160
...
type gb_2 from w_inheritance`gb_2 within w_iocoilsheetqoh_r
integer x = 1650
integer y = 16
integer width = 1518
integer height = 208
...
type gb_1 from w_inheritance`gb_1 within w_iocoilsheetqoh_r
integer x = 3182
integer y = 16
integer width = 763
integer height = 208
...
type dw_2 from w_inheritance`dw_2 within w_iocoilsheetqoh_r
integer x = 64
integer y = 284
integer width = 2322
integer height = 84
