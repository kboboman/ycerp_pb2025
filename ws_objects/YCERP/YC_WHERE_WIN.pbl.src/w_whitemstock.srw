$PBExportHeader$w_whitemstock.srw
$PBExportComments$장기재고관리
forward 
global type w_whitemstock from window
end type
type st_2 from statictext within w_whitemstock
end type
type dw_3 from datawindow within w_whitemstock
end type
type cb_2 from commandbutton within w_whitemstock
end type
type cb_3 from commandbutton within w_whitemstock
end type
type pb_1 from picturebutton within w_whitemstock
end type
type st_8 from statictext within w_whitemstock
end type
type st_qty from statictext within w_whitemstock
end type
type st_cust from statictext within w_whitemstock
end type
type st_5 from statictext within w_whitemstock
end type
type st_4 from statictext within w_whitemstock
end type
type st_seq from statictext within w_whitemstock
end type
type st_order from statictext within w_whitemstock
end type
type st_1 from statictext within w_whitemstock
end type
type cb_1 from commandbutton within w_whitemstock
end type
type dw_1 from datawindow within w_whitemstock
end type
type gb_1 from groupbox within w_whitemstock
end type
type gb_2 from groupbox within w_whitemstock
end type
type gb_3 from groupbox within w_whitemstock
end type
end forward
...
string title = "장기재고(w_whitemstock)"
...
global w_whitemstock w_whitemstock
...
integer height = 1112
integer taborder = 20
string dataobject = "d_whstockalter_m"
...
event itemchanged;//
string ls_item, ls_qa, ls_uom, ls_itemname
real   lr_qoh
long   ll_row, ll_cnt
...
choose case dwo.name
	case "src_item"
			...
			SELECT item_no,item_name,uom INTO :ls_item,:ls_itemname,:ls_uom FROM groupitem WHERE item_no = :ls_item;
	...
	case "src_qa"
			...
			SELECT qoh INTO :lr_qoh FROM itemloc WHERE item_no = :ls_item AND qa = :ls_qa AND loc_no = :is_loc;
