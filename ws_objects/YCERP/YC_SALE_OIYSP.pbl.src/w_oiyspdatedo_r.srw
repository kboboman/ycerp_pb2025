...
type st_3 from statictext within w_oiyspdatedo_r
end type
type ddlb_fld from dropdownlistbox within w_oiyspdatedo_r
end type
type ddlb_dwtitles from dropdownlistbox within w_oiyspdatedo_r
end type
type st_4 from statictext within w_oiyspdatedo_r
end type
type ddlb_op from dropdownlistbox within w_oiyspdatedo_r
end type
type sle_value from singlelineedit within w_oiyspdatedo_r
end type
type cb_1 from commandbutton within w_oiyspdatedo_r
end type
type cb_2 from commandbutton within w_oiyspdatedo_r
end type
type cb_3 from commandbutton within w_oiyspdatedo_r
end type
type cb_5 from commandbutton within w_oiyspdatedo_r
end type
...
integer height = 1256
integer taborder = 0
string dataobject = "d_oiyspdatedo_s2"
...
string dataobject = "d_oiyspdatedo_r2"
