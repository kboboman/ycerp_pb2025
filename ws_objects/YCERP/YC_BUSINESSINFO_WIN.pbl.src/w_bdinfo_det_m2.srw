$PBExportHeader$w_bdinfo_det_m2.srw
$PBExportComments$현장영업진행사황[2000/11/29,서재복]
forward
global type w_bdinfo_det_m2 from w_inheritance
end type
end forward
...
string Title="현장영업진행사황(w_bdinfo_det_m2)"
boolean Resizable=false
WindowState WindowState=normal!
end type
global w_bdinfo_det_m2 w_bdinfo_det_m2
...
on w_bdinfo_det_m2.create
call super::create
end on

on w_bdinfo_det_m2.destroy
call super::destroy
end on
...
type pb_save from w_inheritance`pb_save within w_bdinfo_det_m2
int X=2665
end type
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_det_m2
int X=3323
int Y=60
int Width=448
int Height=392
...
type st_title from w_inheritance`st_title within w_bdinfo_det_m2
string Text="현장영업진행사황"
int TextSize=-20
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_det_m2
int X=1783
int Y=48
boolean Visible=false
end type
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_det_m2
int X=1961
int Y=40
boolean Visible=false
...
type pb_close from w_inheritance`pb_close within w_bdinfo_det_m2
int X=2857
end type
...
type pb_print from w_inheritance`pb_print within w_bdinfo_det_m2
int X=1403
int Y=44
boolean Visible=false
end type

type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_det_m2
int X=1600
int Y=48
boolean Visible=false
boolean Enabled=false
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_det_m2
int X=2473
end type
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_det_m2
int X=2281
end type
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_det_m2
int X=2089
end type
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_det_m2
int X=46
int Y=232
int Width=3031
int Height=1832
...
type gb_2 from w_inheritance`gb_2 within w_bdinfo_det_m2
int X=3323
int Y=8
int Width=512
int Height=624
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_det_m2
int X=2057
int Width=1015
end type

type dw_2 from w_inheritance`dw_2 within w_bdinfo_det_m2
int X=69
int Y=288
int Width=2990
int Height=1744
