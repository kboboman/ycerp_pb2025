...
gb_2.width  = newwidth  - 141
gb_2.height = newheight - 536

dw_1.width  = newwidth  - 201
dw_1.height = newheight - 620
...
Choose Case gs_level
	Case 'A'
		ls_level_userid = '%'
	Case 'B'			
		if gs_userid = '19981214' &
			or gs_userid = 'JDS' or gs_userid = 'hanmr' or gs_userid = 'cider74' or gs_userid = '20000302'&
			or gs_userid = 'berrygrl' or gs_userid = 'woocm'  then
			string sec_userid
