$PBExportHeader$w_whcustret_w.srw
$PBExportComments$거래처검색(2001/06/22,이대준)
forward 
global type w_whcustret_w from window
end type
type cb_18 from commandbutton within w_whcustret_w
end type
type cb_17 from commandbutton within w_whcustret_w
end type
type cb_15 from commandbutton within w_whcustret_w
end type
type pb_2 from picturebutton within w_whcustret_w
end type
type pb_1 from picturebutton within w_whcustret_w
end type
type cb_19 from commandbutton within w_whcustret_w
end type
type dw_1 from datawindow within w_whcustret_w
end type
type cb_16 from commandbutton within w_whcustret_w
end type
type cb_ret from commandbutton within w_whcustret_w
end type
type sle_1 from singlelineedit within w_whcustret_w
end type
type cbx_1 from checkbox within w_whcustret_w
end type
type cb_14 from commandbutton within w_whcustret_w
end type
type cb_13 from commandbutton within w_whcustret_w
end type
type cb_12 from commandbutton within w_whcustret_w
end type
type cb_11 from commandbutton within w_whcustret_w
end type
type cb_10 from commandbutton within w_whcustret_w
end type
type cb_9 from commandbutton within w_whcustret_w
end type
type cb_8 from commandbutton within w_whcustret_w
end type
type cb_7 from commandbutton within w_whcustret_w
end type
type cb_6 from commandbutton within w_whcustret_w
end type
type cb_5 from commandbutton within w_whcustret_w
end type
type cb_4 from commandbutton within w_whcustret_w
end type
type cb_3 from commandbutton within w_whcustret_w
end type
type cb_2 from commandbutton within w_whcustret_w
end type
type cb_1 from commandbutton within w_whcustret_w
end type
type gb_1 from groupbox within w_whcustret_w
end type
end forward
...
global w_whcustret_w w_whcustret_w
