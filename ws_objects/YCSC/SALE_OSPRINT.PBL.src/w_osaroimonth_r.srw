...
type st_2 from statictext within w_osaroimonth_r
end type
type ddlb_1 from dropdownlistbox within w_osaroimonth_r
end type
...
event pb_retrieve::clicked;string ls_sale_flag[]
long ll_year, ll_month
...
dw_1.retrieve(trim(LeftA(dw_area.object.area[1], 1)) + '%', ls_sale_flag, ll_year, ll_month, ls_level_userid)
dw_1.setredraw(true)
...
If gs_level = 'B' Then
	...
	string ls_area
		...
		ls_desc = '사업장:' + ls_areaname + ' 매출년월:' + string(em_1.text) + ' 수주유형:' + ls_sale_flag1
