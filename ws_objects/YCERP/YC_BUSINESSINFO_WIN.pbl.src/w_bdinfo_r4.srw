$PBExportHeader$w_bdinfo_r4.srw
$PBExportComments$판매영업현황조회[2007/06/28,정갑용]
forward
global type w_bdinfo_r4 from w_inheritance
end type
type pb_insert2 from picturebutton within w_bdinfo_r4
end type
type pb_delete2 from picturebutton within w_bdinfo_r4
end type
type ddlb_1 from dropdownlistbox within w_bdinfo_r4
end type
type st_1 from statictext within w_bdinfo_r4
end type
type dw_4 from datawindow within w_bdinfo_r4
end type
type pb_print2 from picturebutton within w_bdinfo_r4
end type
type pb_print1 from picturebutton within w_bdinfo_r4
end type
type dw_5 from datawindow within w_bdinfo_r4
end type
type pb_print3 from picturebutton within w_bdinfo_r4
end type
type dw_3 from datawindow within w_bdinfo_r4
end type
end forward

global type w_bdinfo_r4 from w_inheritance
integer width = 3662
string title = "판매영업현황조회(w_bdinfo_r4)"
...
global w_bdinfo_r4 w_bdinfo_r4
...
string is_organcd, is_designcd, is_buildingcd
string is_scust
end variables
...
public subroutine wf_sortconf ();if dw_2.rowcount() > 0 then
	...
	if ddlb_1.text = '지역별' then
		dw_2.SetSort("bd_positon A, bdinfodet_project A")
	elseif ddlb_1.text = '건설사별' then
		dw_2.SetSort("bdinfodet_buildingcom A, bdinfodet_project A")
	elseif ddlb_1.text = '하도업체별' then
		dw_2.SetSort("bdinfodet_builder A, bdinfodet_project A")
	elseif ddlb_1.text = '준공일별' then
		dw_2.SetSort("bdinfodet_completiondate A, bdinfodet_project A")
	end if
	dw_2.Sort()
	//dw_2.SetRedraw(true)
end if
...
type pb_save from w_inheritance`pb_save within w_bdinfo_r4
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_r4
boolean visible = false
integer x = 1490
integer y = 0
integer width = 110
...
type st_title from w_inheritance`st_title within w_bdinfo_r4
integer width = 1829
integer textsize = -20
long textcolor = 1090519039
string text = "판매영업 현황조회"
end type

type st_tips from w_inheritance`st_tips within w_bdinfo_r4
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_r4
boolean visible = false
integer x = 3858
integer y = 244
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_r4
boolean visible = false
integer x = 3899
integer y = 92
boolean enabled = false
...
type pb_close from w_inheritance`pb_close within w_bdinfo_r4
integer x = 3374
...
type pb_print from w_inheritance`pb_print within w_bdinfo_r4
boolean visible = false
integer x = 4133
integer y = 352
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_r4
boolean visible = false
integer x = 3954
integer y = 292
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_r4
boolean visible = false
integer x = 4306
integer y = 124
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_r4
boolean visible = false
integer x = 4334
integer y = 360
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_r4
integer x = 2606
integer taborder = 160
end type

event pb_retrieve::clicked;if ddlb_1.text = '지역별' then
	dw_2.dataobject = 'd_bdinfo_r4_01'
	dw_3.dataobject = 'd_bdview01_r'
	st_title.text = '판매영업 현황조회(지역)'
elseif ddlb_1.text = '건설사별' then
	dw_2.dataobject = 'd_bdinfo_r4_02'
	dw_3.dataobject = 'd_bdview02_r'
	st_title.text = '판매영업 현황조회(건설사)'
elseif ddlb_1.text = '하도업체별' then
	dw_2.dataobject = 'd_bdinfo_r4_03'
	dw_3.dataobject = 'd_bdview03_r'
	st_title.text = '판매영업 현황조회(하도업체)'
elseif ddlb_1.text = '준공일별' then
	dw_2.dataobject = 'd_bdinfo_r4_04'
	dw_3.dataobject = 'd_bdview04_r'
	st_title.text = '판매영업 현황조회(준공일)'
else
	dw_2.dataobject = 'd_bdinfo_r4_01'
	dw_3.dataobject = 'd_bdview01_r'
	st_title.text = '판매영업 현황조회(지역)'
...
openwithparm(w_bdinfo_w4, ist_where)
...
//	is_speccd = '003'
	...
	is_buildingcd = ist_where.str11
	is_scust = ist_where.str12
...
//	end if
	if isnull(is_build_no) or is_build_no = "" then
		...
		dw_2.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog, is_fixeddate1, is_fixeddate2, is_dprog, is_cprog, is_city, &
							is_person, is_dperson, is_ddiv, is_cperson, is_cdiv, is_bperson, is_bdiv, is_sperson, is_sdiv, is_organcd, is_designcd, is_buildingcd, is_scust)
		wf_setfilter()
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_r4
integer x = 37
integer y = 232
integer width = 3557
end type

type gb_2 from w_inheritance`gb_2 within w_bdinfo_r4
boolean visible = false
integer x = 3808
integer y = 1208
integer width = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_r4
integer x = 2565
integer width = 1024
end type

type dw_2 from w_inheritance`dw_2 within w_bdinfo_r4
integer x = 69
integer y = 284
integer width = 3493
string dataobject = "d_bdinfo_r4_01"
...
string item[] = {"지역별","건설사별","하도업체별","준공일별"}
borderstyle borderstyle = stylelowered!
end type
...
string dataobject = "d_bdview02_r"
...
dw_4.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog,&
				...
				is_bperson, is_bdiv, is_sperson, is_sdiv, is_organcd, is_designcd, is_buildingcd )
...
dw_3.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog,&
				is_fixeddate1, is_fixeddate2, is_dprog, is_cprog, is_city, &
				is_person, is_dperson, is_ddiv, is_cperson, is_cdiv, &
				is_bperson, is_bdiv, is_sperson, is_sdiv, is_organcd, is_designcd, is_buildingcd,is_scust )
...
l_print.st_datawindow = dw_3
l_print.st_print_sheet = " 프린트용지 : A4"
l_print.st_print_desc = " 이 프로그램은 판매영업 현황을 출력합니다." 
...
string dataobject = "d_bdview01_r"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
