$PBExportHeader$w_bdinfo_w2.srw
$PBExportComments$공사정보조회조건-상세[2000/12/08,서재복]
forward
global type w_bdinfo_w2 from window
end type
type st_b from statictext within w_bdinfo_w2
end type
type st_c from statictext within w_bdinfo_w2
end type
type st_d from statictext within w_bdinfo_w2
end type
type dw_12 from datawindow within w_bdinfo_w2
end type
type dw_11 from datawindow within w_bdinfo_w2
end type
type dw_10 from datawindow within w_bdinfo_w2
end type
type st_organ from statictext within w_bdinfo_w2
end type
type dw_9 from datawindow within w_bdinfo_w2
end type
type st_17 from statictext within w_bdinfo_w2
end type
type em_4 from editmask within w_bdinfo_w2
end type
type st_41 from statictext within w_bdinfo_w2
end type
type em_3 from editmask within w_bdinfo_w2
end type
type ddlb_expdate from dropdownlistbox within w_bdinfo_w2
end type
type st_16 from statictext within w_bdinfo_w2
end type
type st_15 from statictext within w_bdinfo_w2
end type
type st_14 from statictext within w_bdinfo_w2
end type
type st_13 from statictext within w_bdinfo_w2
end type
type st_12 from statictext within w_bdinfo_w2
end type
type st_11 from statictext within w_bdinfo_w2
end type
type ddlb_person from dropdownlistbox within w_bdinfo_w2
end type
type ddlb_div from dropdownlistbox within w_bdinfo_w2
end type
type st_10 from statictext within w_bdinfo_w2
end type
type dw_8 from datawindow within w_bdinfo_w2
end type
type st_9 from statictext within w_bdinfo_w2
end type
type dw_5 from datawindow within w_bdinfo_w2
end type
type st_8 from statictext within w_bdinfo_w2
end type
type dw_7 from datawindow within w_bdinfo_w2
end type
type dw_6 from datawindow within w_bdinfo_w2
end type
type st_7 from statictext within w_bdinfo_w2
end type
type st_6 from statictext within w_bdinfo_w2
end type
type sle_project from singlelineedit within w_bdinfo_w2
end type
type st_5 from statictext within w_bdinfo_w2
end type
type st_4 from statictext within w_bdinfo_w2
end type
type st_1 from statictext within w_bdinfo_w2
end type
type dw_3 from datawindow within w_bdinfo_w2
end type
type dw_2 from datawindow within w_bdinfo_w2
end type
type dw_1 from datawindow within w_bdinfo_w2
end type
type st_3 from statictext within w_bdinfo_w2
end type
type st_2 from statictext within w_bdinfo_w2
end type
type em_2 from editmask within w_bdinfo_w2
end type
type em_1 from editmask within w_bdinfo_w2
end type
type pb_2 from picturebutton within w_bdinfo_w2
end type
type pb_1 from picturebutton within w_bdinfo_w2
end type
type gb_1 from groupbox within w_bdinfo_w2
end type
end forward
...
global w_bdinfo_w2 w_bdinfo_w2
...
//	select min(dexpdate) into :ld_minfixeddate from bdinfodet ;
//	select max(dexpdate) into :ld_maxfixeddate from bdinfodet ;	
//	select min(makedate) into :ld_minfixeddate from bdinfodet ;
//	select max(makedate) into :ld_maxfixeddate from bdinfodet ;	
//	em_3.text = string(ld_minfixeddate, "yyyy/mm/dd")
//	em_4.text = string(ld_maxfixeddate, "yyyy/mm/dd")
	em_3.text = string('00000000', "yyyy/mm/dd") 
	em_4.text = string('00000000', "yyyy/mm/dd") 
else
	em_3.text = ist_where.sdate3
	em_4.text = string(RelativeDate(date(ist_where.sdate4), -1)) 
end if
...
ist_where.sdate1 = trim(em_1.text) //영업진행일자
ist_where.sdate2 = string(RelativeDate(date(trim(em_2.text)), 1))
ist_where.sdate3 = trim(em_3.text)  //예정일자
ist_where.sdate4 = string(RelativeDate(date(trim(em_4.text)), 1))
