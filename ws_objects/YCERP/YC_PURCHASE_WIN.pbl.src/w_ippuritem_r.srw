...
type st_5 from statictext within w_ippuritem_r
end type
type ddlb_fld from dropdownlistbox within w_ippuritem_r
end type
type ddlb_dwtitles from dropdownlistbox within w_ippuritem_r
end type
type st_6 from statictext within w_ippuritem_r
end type
type ddlb_op from dropdownlistbox within w_ippuritem_r
end type
type sle_value from singlelineedit within w_ippuritem_r
end type
type cb_1 from commandbutton within w_ippuritem_r
end type
type cb_2 from commandbutton within w_ippuritem_r
end type
type cb_3 from commandbutton within w_ippuritem_r
end type
type cb_5 from commandbutton within w_ippuritem_r
end type
end forward
