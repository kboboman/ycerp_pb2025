...
type p_2 from picture within w_calendar
end type
type p_1 from picture within w_calendar
end type
end forward
...
//
if Isdate(ls_today) then
	idt_day      = date( ls_today )
	em_date.text = ls_today
else
...
event clicked;string ls_date, ls_column
