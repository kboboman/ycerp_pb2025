$PBExportHeader$w_bdinfo_r2.srw
$PBExportComments$설계영업현황조회-상세[2001/01/18,서재복]
forward
global type w_bdinfo_r2 from w_inheritance
end type
type pb_insert2 from picturebutton within w_bdinfo_r2
end type
type pb_delete2 from picturebutton within w_bdinfo_r2
end type
type ddlb_1 from dropdownlistbox within w_bdinfo_r2
end type
type st_1 from statictext within w_bdinfo_r2
end type
type dw_3 from datawindow within w_bdinfo_r2
end type
type dw_4 from datawindow within w_bdinfo_r2
end type
type pb_print2 from picturebutton within w_bdinfo_r2
end type
type pb_print1 from picturebutton within w_bdinfo_r2
end type
type dw_5 from datawindow within w_bdinfo_r2
end type
type pb_print3 from picturebutton within w_bdinfo_r2
end type
type st_2 from statictext within w_bdinfo_r2
end type
end forward

global type w_bdinfo_r2 from w_inheritance
integer width = 3662
string title = "설계영업현황조회-상세(w_bdinfo_r2)"
...
global w_bdinfo_r2 w_bdinfo_r2
...
this.Control[iCurrent+7]=this.pb_print2
this.Control[iCurrent+8]=this.pb_print1
this.Control[iCurrent+9]=this.dw_5
this.Control[iCurrent+10]=this.pb_print3
this.Control[iCurrent+11]=this.st_2
end on

on w_bdinfo_r2.destroy
call super::destroy
...
type pb_save from w_inheritance`pb_save within w_bdinfo_r2
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_r2
boolean visible = false
integer x = 3845
integer y = 1260
integer width = 448
...
//	dw_2.reset()
//	dw_2.retrieve(is_build_no, ls_divcd, ls_speccd, ls_project, is_sprog, ld_fixeddate1, ld_fixeddate2, is_dprog, is_cprog, is_city)
//	dw_2.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog, id_fixeddate1, id_fixeddate2, is_dprog, is_cprog, is_city, &
//	is_person, id_makedate1, id_makedate2, is_dperson, is_ddiv, id_dexpdate1, id_dexpdate2, is_cperson, is_cdiv, id_cexpdate1, &
//	id_cexpdate2, is_bperson, is_bdiv, id_bexpdate1, id_bexpdate2, is_sperson, is_sdiv, id_sexpdate1, id_sexpdate2)
	dw_2.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog, id_fixeddate1, id_fixeddate2, is_dprog, is_cprog, is_city, &
...
type st_title from w_inheritance`st_title within w_bdinfo_r2
integer width = 1627
integer textsize = -20
long textcolor = 1090519039
string text = "설계영업현황조회-상세"
end type

type st_tips from w_inheritance`st_tips within w_bdinfo_r2
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_r2
boolean visible = false
integer x = 3858
integer y = 244
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_r2
boolean visible = false
integer x = 3899
integer y = 92
boolean enabled = false
...
type pb_close from w_inheritance`pb_close within w_bdinfo_r2
integer x = 3374
...
type pb_print from w_inheritance`pb_print within w_bdinfo_r2
boolean visible = false
integer x = 4133
integer y = 352
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_r2
boolean visible = false
integer x = 3954
integer y = 292
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_r2
boolean visible = false
integer x = 4306
integer y = 124
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_r2
boolean visible = false
integer x = 4334
integer y = 360
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_r2
integer x = 2606
integer taborder = 170
end type

event pb_retrieve::clicked;openwithparm(w_bdinfo_w2, ist_where)
...
if ist_where.okflag = true then
	...
	if is_sprog = '010' then
		st_title.text = "설계진행현황-상세"
	elseif is_sprog = '020' then
		st_title.text = "설계확정현황-상세"
	else
		st_title.text = "설계영업현황(전체)-상세"
	end if
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_r2
integer x = 37
integer y = 232
integer width = 3557
end type

type gb_2 from w_inheritance`gb_2 within w_bdinfo_r2
boolean visible = false
integer x = 3808
integer y = 1208
integer width = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_r2
integer x = 2565
integer width = 1024
end type

type dw_2 from w_inheritance`dw_2 within w_bdinfo_r2
integer x = 69
integer y = 284
integer width = 3493
string dataobject = "d_bdinfo_r2"
...
event dw_2::retrieveend;wf_setfilter()
end event
...
string item[] = {"확정구분","진행일자","프로젝트명","담당본부","제품","지역"}
borderstyle borderstyle = stylelowered!
end type
...
boolean bringtotop = true
string dataobject = "d_infodet_p1d"
...
boolean bringtotop = true
string dataobject = "d_infodet_p2d"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
dw_4.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog, id_fixeddate1, id_fixeddate2, is_dprog, is_cprog, is_city, &
is_person, is_dperson, is_ddiv, is_cperson, is_cdiv, is_bperson, is_bdiv, is_sperson, is_sdiv, is_organcd, is_designcd )
...
if isnull(id_fixeddate1) then
	...
	w_print.dw_1.object.t_end.text = string(RelativeDate(id_fixeddate2, -1), 'YYYY/MM/DD')
end if
...
if is_sprog = '010' then
	w_print.dw_1.object.t_title.text = '설계진행현황-상세'
elseif is_sprog = '020' then
	w_print.dw_1.object.t_title.text = '설계확정현황-상세'
else
	w_print.dw_1.object.t_title.text = '설계영업현황(전체)-상세'
end if
...
integer taborder = 90
boolean bringtotop = true
string dataobject = "d_infodet_p3d"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
dw_5.retrieve(is_build_no, is_divcd, is_speccd, is_project, is_sprog, id_fixeddate1, id_fixeddate2, is_dprog, is_cprog, is_city, &
is_person, is_dperson, is_ddiv, is_cperson, is_cdiv, is_bperson, is_bdiv, is_sperson, is_sdiv, is_organcd, is_designcd)
wf_setfilter2()
