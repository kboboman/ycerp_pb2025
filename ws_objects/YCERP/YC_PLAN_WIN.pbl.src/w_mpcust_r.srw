...
type st_1 from statictext within w_mpcust_r
end type
type st_2 from statictext within w_mpcust_r
end type
type gb_15 from groupbox within w_mpcust_r
end type
type gb_4 from groupbox within w_mpcust_r
end type
end forward
...
integer width = 4398
integer height = 2208
string title = "생산계획 조회(거래처별)(w_mpcust_r)"
cb_1 cb_1
em_1 em_1
em_2 em_2
dw_3 dw_3
...
this.Control[iCurrent+12]=this.gb_15
