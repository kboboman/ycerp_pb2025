...
type pb_1 from picturebutton within w_oiitemsum_r
end type
...
this.Control[iCurrent+22]=this.cbx_haphd
...
gb_3.visible = false
st_7.visible = false
cbx_team.visible = false
dw_sales.visible = false
dw_2.visible = false
...
dw_1.retrieve( ls_area, ls_custno, ld_sdate, ld_edate )
