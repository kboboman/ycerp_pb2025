...
type gb_2 from groupbox within w_cdzipcode_s
end type
...
if gs_zipcodes1 = 'w_cdcustomer_m' and gs_zipcodes2 = 'addr1' then
	...
	ll_dw5row = w_cdcustomer_m.tab_1.tabpage_1.dw_5.getrow()
	if	w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemchanged( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.addr2, ls_address ) = 1 then
		w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemerror( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.addr2, ls_address )
	end if
end if
...
if gs_zipcodes1 = 'w_cdcustomer_m' and gs_zipcodes2 = 'bus_addr1' then
	...
	ll_dw5row = w_cdcustomer_m.tab_1.tabpage_1.dw_5.getrow()
	if	w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemchanged( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.bus_addr1, ls_address ) = 1 then
		w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemerror( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.bus_addr2, ls_address )
	end if
end if
...
if gs_zipcodes1 = 'w_cdcustomer_m' and gs_zipcodes2 = 'shipto_addr1' then
	...
	ll_dw5row = w_cdcustomer_m.tab_1.tabpage_1.dw_5.getrow()
	if	w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemchanged( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.shipto_addr1, ls_address ) = 1 then
		w_cdcustomer_m.tab_1.tabpage_1.dw_5.event itemerror( ll_dw5row, w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.shipto_addr2, ls_address )
	end if
end if
...
string ls_custno, ls_haddr, ls_hbusaddr, ls_hshipaddr

ls_custno = w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.cust_no[1]
if isnull(ls_custno) or ls_custno = "" then
else
	SELECT TOP 1 address INTO :ls_haddr     FROM customer_addrhis 
	 WHERE cust_no = :ls_custno AND addr_type = '1' ORDER BY sys_date desc;
	 
	SELECT TOP 1 address INTO :ls_hbusaddr  FROM customer_addrhis 
	 WHERE cust_no = :ls_custno AND addr_type = '2' ORDER BY sys_date desc;
	 
	SELECT TOP 1 address INTO :ls_hshipaddr FROM customer_addrhis 
	 WHERE cust_no = :ls_custno AND addr_type = '3' ORDER BY sys_date desc;
	
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.haddr[1] = ls_haddr
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.hbus_addr[1] = ls_hbusaddr
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.hshipto_addr[1] = ls_hshipaddr
	
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.c_addr.visible = true
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.c_bus_addr.visible = true
	w_cdcustomer_m.tab_1.tabpage_1.dw_5.object.c_shipto_addr.visible = true
end if
