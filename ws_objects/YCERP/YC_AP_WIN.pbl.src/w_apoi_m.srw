...
type st_2 from statictext within w_apoi_m
end type
type st_3 from statictext within w_apoi_m
end type
type st_1 from statictext within w_apoi_m
end type
type st_4 from statictext within w_apoi_m
end type
type st_5 from statictext within w_apoi_m
end type
type st_vertical from u_splitbar_vertical within w_apoi_m
end type
type st_horizontal from u_splitbar_horizontal within w_apoi_m
end type
type st_6 from statictext within w_apoi_m
end type
type ddlb_fld from dropdownlistbox within w_apoi_m
end type
type ddlb_dwtitles from dropdownlistbox within w_apoi_m
end type
type st_7 from statictext within w_apoi_m
end type
type ddlb_op from dropdownlistbox within w_apoi_m
end type
type sle_value from singlelineedit within w_apoi_m
end type
type cb_1 from commandbutton within w_apoi_m
end type
type cb_2 from commandbutton within w_apoi_m
end type
type cb_3 from commandbutton within w_apoi_m
end type
type cb_5 from commandbutton within w_apoi_m
end type
...
this.Control[iCurrent+9]=this.ddlb_2
...
////////////////////////////////////////////////////////////////////////////////////////////
st_vertical.of_set_leftobject( mle_1 )
st_vertical.of_set_rightobject( dw_2 )
st_vertical.of_set_minsize(250, 250)

st_horizontal.of_set_topobject( mle_1 )
...
st_vertical.x      = mle_1.x + mle_1.width
st_vertical.height = mle_1.height

dw_2.x      = st_vertical.x + st_vertical.width
dw_2.width  = newwidth - dw_2.x - mle_1.x
dw_2.height = mle_1.height

st_horizontal.y     = mle_1.y + mle_1.height
st_horizontal.width = mle_1.width + st_vertical.width + dw_2.width
...
lst_apoi.name = ""	//is_dw7nm //'d_osaroi_s'
//lst_apoi.dw_object = dw_7

openwithparm(w_apoi_m1, lst_apoi) 

lst_apoi = message.powerobjectparm

if lst_apoi.flag = 'N' then return
...
SELECT round INTO :is_round FROM supp WHERE supp_no = :ls_supp_no;
