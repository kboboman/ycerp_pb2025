$PBExportHeader$w_whretrieve_w.srw
$PBExportComments$품목 코드 검색윈도우(1998/05/08, 정재수)
forward
global type w_whretrieve_w from window
end type
type pb_2 from picturebutton within w_whretrieve_w
end type
type pb_1 from picturebutton within w_whretrieve_w
end type
type st_1 from statictext within w_whretrieve_w
end type
type em_2 from editmask within w_whretrieve_w
end type
type em_1 from editmask within w_whretrieve_w
end type
type rb_2 from radiobutton within w_whretrieve_w
end type
type rb_1 from radiobutton within w_whretrieve_w
end type
type gb_1 from groupbox within w_whretrieve_w
end type
end forward
...
string title = "조회(w_whretrieve_w)"
...
global w_whretrieve_w w_whretrieve_w

type variables
gs_codere_str  ist_code
end variables

on w_whretrieve_w.create
