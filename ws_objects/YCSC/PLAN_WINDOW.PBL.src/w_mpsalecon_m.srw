...
type st_3 from statictext within w_mpsalecon_m
end type
...
type st_4 from statictext within w_mpsalecon_m
end type
...
type st_8 from statictext within w_mpsalecon_m
end type
type ddlb_col from dropdownlistbox within w_mpsalecon_m
end type
type st_9 from statictext within w_mpsalecon_m
end type
type ddlb_2 from dropdownlistbox within w_mpsalecon_m
end type
type sle_value from singlelineedit within w_mpsalecon_m
end type
type cb_filteron from commandbutton within w_mpsalecon_m
end type
type cb_filteroff from commandbutton within w_mpsalecon_m
end type
type cb_7 from commandbutton within w_mpsalecon_m
end type
...
integer width = 4805
integer height = 2772
string title = "판매수주확정(w_mpsalecon_m)"
...
this.Control[iCurrent+31]=this.cb_13
end on
...
event resize;call super::resize;dw_3.height = this.height - 1588
