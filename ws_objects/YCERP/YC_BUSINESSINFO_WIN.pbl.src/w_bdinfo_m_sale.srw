$PBExportHeader$w_bdinfo_m_sale.srw
$PBExportComments$설계영업진행관리[2001/01/18,서재복]
forward
global type w_bdinfo_m_sale from w_inheritance
end type
type dw_plist from datawindow within w_bdinfo_m_sale
end type
type pb_insert2 from picturebutton within w_bdinfo_m_sale
end type
type pb_delete2 from picturebutton within w_bdinfo_m_sale
end type
type gb_4 from groupbox within w_bdinfo_m_sale
end type
type pb_print3 from picturebutton within w_bdinfo_m_sale
end type
type dw_print5 from datawindow within w_bdinfo_m_sale
end type
type tab_1 from tab within w_bdinfo_m_sale
end type
...
type cb_wf_ret from commandbutton within w_bdinfo_m_sale
end type
end forward
...
integer width = 4658
integer height = 2876
string title = "판매영업진행입력(w_bdinfo_m_sale)"
...
global w_bdinfo_m_sale w_bdinfo_m_sale
...
type pb_save from w_inheritance`pb_save within w_bdinfo_m_sale
integer x = 3182
end type
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_m_sale
...
type st_title from w_inheritance`st_title within w_bdinfo_m_sale
integer y = 36
integer height = 164
integer textsize = -20
...
type st_tips from w_inheritance`st_tips within w_bdinfo_m_sale
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_m_sale
boolean visible = false
integer x = 4087
integer y = 64
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_m_sale
boolean visible = false
integer x = 4233
integer y = 64
...
type pb_close from w_inheritance`pb_close within w_bdinfo_m_sale
integer x = 3374
...
type pb_print from w_inheritance`pb_print within w_bdinfo_m_sale
boolean visible = false
integer x = 3739
integer y = 64
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_m_sale
boolean visible = false
integer x = 3927
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_m_sale
integer x = 2990
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_m_sale
integer x = 2798
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_m_sale
integer x = 2414
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_m_sale
string tag = "736"
integer x = 741
integer y = 216
integer width = 3141
...
type gb_2 from w_inheritance`gb_2 within w_bdinfo_m_sale
boolean visible = false
integer x = 3749
integer y = 948
integer width = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_m_sale
integer x = 2373
integer width = 1216
end type

type dw_2 from w_inheritance`dw_2 within w_bdinfo_m_sale
integer x = 763
integer y = 268
integer width = 3099
integer height = 484
integer taborder = 60
string dataobject = "d_bdinfo_m_sale"
...
if tab_1.tabpage_1.dw_3.getrow() > 0 then
	...
	gs_var2 = tab_1.tabpage_1.dw_3.object.bdinfodet_builder[tab_1.tabpage_1.dw_3.getrow()]
...
integer taborder = 100
string title = "none"
string dataobject = "d_bdinfo_m2_sale"
boolean border = false
boolean livescroll = true
end type
...
//	case 'bdinfodet_master'
//			if isnull(dw_2.object.bdinfodet_project[dw_2.getrow()]) and isnull(data) then
//			else
//				tab_1.tabpage_2.enabled = true
//			end if
	case 'bdinfodet_builder'
