$PBExportHeader$nvo_osversion.sru
$PBExportComments$Winsock functions
forward
global type nvo_osversion from nonvisualobject
end type
type osversioninfoex from structure within nvo_osversion
end type
type system_info from structure within nvo_osversion
end type
type langandcodepage from structure within nvo_osversion
end type
type vs_fixedfileinfo from structure within nvo_osversion
end type
end forward
...
global type nvo_osversion from nonvisualobject autoinstantiate
end type
...
on nvo_osversion.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_osversion.destroy
