$PBExportHeader$w_bdinfo_w_s2.srw
forward
global type w_bdinfo_w_s2 from window
end type
type cb_3 from commandbutton within w_bdinfo_w_s2
end type
type cb_2 from commandbutton within w_bdinfo_w_s2
end type
type dw_1 from datawindow within w_bdinfo_w_s2
end type
type cb_1 from commandbutton within w_bdinfo_w_s2
end type
type sle_1 from singlelineedit within w_bdinfo_w_s2
end type
type pb_2 from picturebutton within w_bdinfo_w_s2
end type
type pb_1 from picturebutton within w_bdinfo_w_s2
end type
type gb_1 from groupbox within w_bdinfo_w_s2
end type
end forward
...
string title = "설계사 검색/등록(w_bdinfo_w_s2)"
...
global w_bdinfo_w_s2 w_bdinfo_w_s2
...
event clicked;if dw_1.getrow() > 0 then
	...
	openwithparm(w_cdmaster_m2, ist_where)
...
integer taborder = 30
string title = "none"
string dataobject = "d_bdsearch_design_s2"
