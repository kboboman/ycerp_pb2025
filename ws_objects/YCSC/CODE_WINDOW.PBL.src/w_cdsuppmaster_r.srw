...
integer width = 3593
integer height = 1852
string title = "자재거래처관리(w_cdsuppmaster_r)"
dw_4 dw_4
em_1 em_1
st_1 st_1
dw_5 dw_5
...
event pb_retrieve::clicked;long ll_year
string ls_supp
...
dw_2.retrieve(ls_supp, integer(ll_year))
dw_4.retrieve(ls_supp, integer(ll_year) - 1)

dw_5.retrieve(ls_supp, integer(ll_year))
