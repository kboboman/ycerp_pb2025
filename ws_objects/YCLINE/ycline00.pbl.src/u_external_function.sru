...
public function unsignedinteger uf_getdrivetype (integer ai_drive)
...
If RightA(ls_Path, 1) <> is_Separator Then
...
If IsNull(as_path) or LenA(Trim(as_path))=0 Then
	Return -1
End If
...
Return uf_LastPos (as_source, as_target, LenA(as_Source))
end function
...
public function unsignedinteger uf_getdrivetype (integer ai_drive);//drive types
return 0
