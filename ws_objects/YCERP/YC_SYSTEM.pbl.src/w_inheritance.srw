...
$PBExportComments$상속윈도우(1998/01/01,곽용덕)
forward
global type w_inheritance from window
end type
type pb_save from picturebutton within w_inheritance
end type
type dw_1 from datawindow within w_inheritance
end type
type st_title from statictext within w_inheritance
end type
type st_tips from statictext within w_inheritance
end type
type pb_compute from picturebutton within w_inheritance
end type
type pb_print_part from picturebutton within w_inheritance
end type
type pb_close from picturebutton within w_inheritance
end type
type pb_print from picturebutton within w_inheritance
end type
type pb_cancel from picturebutton within w_inheritance
end type
type pb_delete from picturebutton within w_inheritance
end type
type pb_insert from picturebutton within w_inheritance
end type
type pb_retrieve from picturebutton within w_inheritance
end type
type gb_3 from groupbox within w_inheritance
end type
type gb_2 from groupbox within w_inheritance
end type
type gb_1 from groupbox within w_inheritance
end type
type dw_2 from datawindow within w_inheritance
end type
end forward
...
event open;//
// Datawindow ROW BackColor
// if ( getrow() = currentrow(), rgb(254, 252, 175), rgb(255, 255, 255) )
//
// 해상도
if GE_Environment.ScreenWidth <= 1152 then 
...
event closequery;string	ls_update
