$PBExportHeader$w_iractio_new_m.srw
$PBExportComments$실사입력 및 갱신(2000/09/02)
forward
global type w_iractio_new_m from w_inheritance
end type
type gb_7 from groupbox within w_iractio_new_m
end type
type gb_4 from groupbox within w_iractio_new_m
end type
type sle_1 from singlelineedit within w_iractio_new_m
end type
type rb_1 from radiobutton within w_iractio_new_m
end type
type rb_2 from radiobutton within w_iractio_new_m
end type
type em_1 from editmask within w_iractio_new_m
end type
type dw_3 from datawindow within w_iractio_new_m
end type
type cbx_2 from checkbox within w_iractio_new_m
end type
type hpb_1 from hprogressbar within w_iractio_new_m
end type
type st_3 from statictext within w_iractio_new_m
end type
type ddlb_fld from dropdownlistbox within w_iractio_new_m
end type
type ddlb_dwtitles from dropdownlistbox within w_iractio_new_m
end type
type st_2 from statictext within w_iractio_new_m
end type
type ddlb_op from dropdownlistbox within w_iractio_new_m
end type
type sle_value from singlelineedit within w_iractio_new_m
end type
type cb_2 from commandbutton within w_iractio_new_m
end type
type cb_3 from commandbutton within w_iractio_new_m
end type
type cb_4 from commandbutton within w_iractio_new_m
end type
type cb_5 from commandbutton within w_iractio_new_m
end type
type cb_1 from commandbutton within w_iractio_new_m
end type
type cb_6 from commandbutton within w_iractio_new_m
end type
type st_4 from statictext within w_iractio_new_m
end type
type st_6 from statictext within w_iractio_new_m
end type
type st_12 from statictext within w_iractio_new_m
end type
type cb_9 from commandbutton within w_iractio_new_m
end type
type dwxls from datawindow within w_iractio_new_m
end type
type rb_10 from radiobutton within w_iractio_new_m
end type
type rb_11 from radiobutton within w_iractio_new_m
end type
type ddlb_gubun from dropdownlistbox within w_iractio_new_m
end type
type pb_retrieve1 from picturebutton within w_iractio_new_m
end type
type rb_12 from radiobutton within w_iractio_new_m
end type
type dw_4 from datawindow within w_iractio_new_m
end type
type pb_1 from picturebutton within w_iractio_new_m
end type
type cb_10 from commandbutton within w_iractio_new_m
end type
type cb_7 from commandbutton within w_iractio_new_m
end type
type cb_8 from commandbutton within w_iractio_new_m
end type
type st_1 from statictext within w_iractio_new_m
end type
type cbx_comment from checkbox within w_iractio_new_m
end type
type st_5 from statictext within w_iractio_new_m
end type
type dw_sales from datawindow within w_iractio_new_m
end type
type st_7 from statictext within w_iractio_new_m
end type
type cb_11 from commandbutton within w_iractio_new_m
end type
type rb_all from radiobutton within w_iractio_new_m
end type
type rb_etc from radiobutton within w_iractio_new_m
end type
type gb_5 from groupbox within w_iractio_new_m
end type
type gb_6 from groupbox within w_iractio_new_m
end type
type gb_8 from groupbox within w_iractio_new_m
end type
end forward
...
integer width = 8622
integer height = 3312
string title = "실사 마감(w_iractio_new_m)"
gb_7 gb_7
gb_4 gb_4
sle_1 sle_1
rb_1 rb_1
...
global w_iractio_new_m w_iractio_new_m

type variables
string ls_click = ''
st_print i_print
datawindowchild  idwc_qa, idwc_item, idwc_loc, idwc_user
...
this.cbx_comment=create cbx_comment
this.st_5=create st_5
this.dw_sales=create dw_sales
this.st_7=create st_7
this.cb_11=create cb_11
this.rb_all=create rb_all
this.rb_etc=create rb_etc
...
this.Control[iCurrent+38]=this.cbx_comment
this.Control[iCurrent+39]=this.st_5
this.Control[iCurrent+40]=this.dw_sales
this.Control[iCurrent+41]=this.st_7
this.Control[iCurrent+42]=this.cb_11
this.Control[iCurrent+43]=this.rb_all
this.Control[iCurrent+44]=this.rb_etc
this.Control[iCurrent+45]=this.gb_5
this.Control[iCurrent+46]=this.gb_6
this.Control[iCurrent+47]=this.gb_8
end on

on w_iractio_new_m.destroy
call super::destroy
destroy(this.gb_7)
destroy(this.gb_4)
destroy(this.sle_1)
...
/*2019-10-03 jowonsuk 13일부터는 당월로 그이전은 전월로 */
l_st_day = 13
...
type pb_save from w_inheritance`pb_save within w_iractio_new_m
integer x = 5376
integer y = 56
integer taborder = 40
...
type dw_1 from w_inheritance`dw_1 within w_iractio_new_m
...
integer height = 1848
integer taborder = 60
string dataobject = "d_iractio_new_m_new"
end type
...
type st_title from w_inheritance`st_title within w_iractio_new_m
integer x = 23
integer y = 28
integer width = 1239
...
type st_tips from w_inheritance`st_tips within w_iractio_new_m
end type

type pb_compute from w_inheritance`pb_compute within w_iractio_new_m
integer x = 5765
integer y = 56
...
f_usetips(st_tips,"태그출력",parent, li_x, li_y)
end event

event pb_compute::clicked;call super::clicked;decimal l_qty
string     ls_loc_name, ls_item_no, ls_item_name, ls_qa_name, ls_manager_name, ls_return, ls_tag

long l_row, ll_row, ll_cnt, l_return_number

dwxls.dataobject=  'd_iractio_new_tag'
...
//	OpenWithParm( w_poptag,  ls_return)
//	ls_return = trim(Message.StringParm)
	
//	l_return_number = long(mid(ls_return,3, len(ls_return)))

	for ll_cnt = 1 to ll_row
			
			l_qty                 = dw_1.object.silsa_qty[ll_cnt]
			ls_loc_name    = dw_1.object.loc_name[ll_cnt]
			ls_item_no       = dw_1.object.item_no[ll_cnt] 
			ls_item_name  = dw_1.object.item_name[ll_cnt]
			ls_qa_name     = dw_1.object.qa[ll_cnt]   
			ls_manager_name = dw_1.object.user_name[ll_cnt]   
			
//			if len(ls_return) = 2 then
//				ls_tag                      = ls_return+ trim(string(ll_cnt, '000'))
//			else
//				
//				ls_tag = left(ls_return,2) + trim( string(l_return_number, '000') )
//				
//				l_return_number = l_return_number + 1
//								
//			end if				
			
			
			if mod( ll_cnt, 4) = 1 then		
					l_row = dwxls.insertrow(0);				
			end if			
										
			if mod( ll_cnt, 4) = 1 then				
					dwxls.object.item_name1[l_row] = ls_item_name
					dwxls.object.item_no1[l_row] = ls_item_no
					dwxls.object.item_qa1[l_row] = ls_qa_name
					dwxls.object.location1[l_row] = ls_loc_name	
					dwxls.object.manager1[l_row] = ls_manager_name	
					dwxls.object.qty1[l_row] = l_qty					
//					dwxls.object.tag1[l_row] = ls_tag							
					
			elseif mod( ll_cnt, 4) = 2 then								
					dwxls.object.item_name2[l_row] = ls_item_name
					dwxls.object.item_no2[l_row] = ls_item_no
					dwxls.object.item_qa2[l_row] = ls_qa_name
					dwxls.object.location2[l_row] = ls_loc_name					
					dwxls.object.manager2[l_row] = ls_manager_name					
					dwxls.object.qty2[l_row] = l_qty					
//					dwxls.object.tag2[l_row] = ls_tag												
					
			elseif mod( ll_cnt, 4) = 3 then					
					dwxls.object.item_name3[l_row] = ls_item_name
					dwxls.object.item_no3[l_row] = ls_item_no
					dwxls.object.item_qa3[l_row] = ls_qa_name
					dwxls.object.location3[l_row] = ls_loc_name		
					dwxls.object.manager3[l_row] = ls_manager_name					
					dwxls.object.qty3[l_row] = l_qty					
//					dwxls.object.tag3[l_row] = ls_tag												
					
			elseif mod( ll_cnt, 4) = 0 then							
					dwxls.object.item_name4[l_row] = ls_item_name
					dwxls.object.item_no4[l_row] = ls_item_no
					dwxls.object.item_qa4[l_row] = ls_qa_name
					dwxls.object.location4[l_row] = ls_loc_name									
					dwxls.object.manager4[l_row] = ls_manager_name					
					dwxls.object.qty4[l_row] = l_qty								
//					dwxls.object.tag4[l_row] = ls_tag												
			end if	
	...
	i_print.st_datawindow  = dwxls
	i_print.st_print_sheet = " 프린트용지 : A4"
	i_print.st_print_desc  = " 이 프로그램은 실사목록 리스트를 출력합니다." 
	//i_print.name = 'd_irincoun_r'
	
	gs_print_control = 'DataWindow.Print.Orientation=1 DataWindow.Print.Paper.Size=10 Datawindow.Zoom=100 DataWindow.print.margin.left = 0 DataWindow.print.margin.right = 0 DataWindow.print.margin.top = 0 DataWindow.print.margin.bottom = 0'
	opensheetwithparm(w_print, i_print, parentwindow(), 1, Original!)

else
	messagebox('알림','태그를 출력할 내용이 없습니다.')
end if
end event

type pb_print_part from w_inheritance`pb_print_part within w_iractio_new_m
...
type pb_close from w_inheritance`pb_close within w_iractio_new_m
integer x = 5961
integer y = 56
...
type pb_print from w_inheritance`pb_print within w_iractio_new_m
integer x = 5175
integer y = 56
...
//================================================================================================
string ls_location, ls_year, ls_code, ls_name, ls_factory
...
dw_4.reset()
dw_4.retrieve(ls_location, ls_year , ls_factory)

if rb_all.checked = true then	//전체
	if cbx_comment.checked then
		if rb_10.checked then
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '1', '2' ) ")
		elseif rb_11.checked then	
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")	
		elseif rb_12.checked then	
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")
		end if	
	else
		if rb_10.checked then
			dw_4.setfilter(" p4 in ( '1', '2' ) ")
		elseif rb_11.checked then	
			dw_4.setfilter(" p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")	
		elseif rb_12.checked then	
			dw_4.setfilter(" p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")
		end if		
	end if
else									//재고조정차이
	if cbx_comment.checked then
		if rb_10.checked then
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '1', '2' ) and (plus_qty <> 0 or minus_qty <> 0) ")
		elseif rb_11.checked then	
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (plus_qty <> 0 or minus_qty <> 0) ")	
		elseif rb_12.checked then	
			dw_4.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (plus_qty <> 0 or minus_qty <> 0) ")
		end if	
	else
		if rb_10.checked then
			dw_4.setfilter(" p4 in ( '1', '2' ) and (plus_qty <> 0 or minus_qty <> 0) ")
		elseif rb_11.checked then	
			dw_4.setfilter(" p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (plus_qty <> 0 or minus_qty <> 0) ")	
		elseif rb_12.checked then	
			dw_4.setfilter(" p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (plus_qty <> 0 or minus_qty <> 0) ")
		end if		
	end if
end if
dw_4.filter()
...
type pb_cancel from w_inheritance`pb_cancel within w_iractio_new_m
boolean visible = false
integer x = 4265
integer y = 1436
integer width = 251
...
type pb_delete from w_inheritance`pb_delete within w_iractio_new_m
boolean visible = false
integer x = 6578
integer y = 64
...
type pb_insert from w_inheritance`pb_insert within w_iractio_new_m
integer x = 4983
integer y = 56
...
type pb_retrieve from w_inheritance`pb_retrieve within w_iractio_new_m
integer x = 4791
integer y = 56
...
if l_count = 0 then
	...
	DECLARE dt_silsa_itemstock procedure for dt_silsa_itemstock :ls_year, :ls_location using sqlca;
...
if rb_all.checked = true then	//전체
	if cbx_comment.checked then
		if rb_10.checked then
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '1', '2' ) ")
		elseif rb_11.checked then	
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")	
		elseif rb_12.checked then	
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') ")
		end if	
	else
		if rb_10.checked then
	...
	if cbx_comment.checked then
		if rb_10.checked then
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '1', '2' ) and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")
		elseif rb_11.checked then	
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")	
		elseif rb_12.checked then	
			dw_1.setfilter(" (stock_qty <> silsa_qty and comment_check = '') and p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")
		end if	
	else
		if rb_10.checked then
			dw_1.setfilter(" p4 in ( '1', '2' ) and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")
		elseif rb_11.checked then	
			dw_1.setfilter(" p4 in ( '0', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")	
		elseif rb_12.checked then	
			dw_1.setfilter(" p4 in ( '0', '1', '2', '5', '8', 'A', 'C', 'G', 'M', 'P', 'S', 'U', 'Z') and (erp_plus_qty <> 0 or erp_minus_qty <> 0) ")
		end if		
	end if
end if
...
type gb_3 from w_inheritance`gb_3 within w_iractio_new_m
integer x = 4238
integer y = 1372
integer width = 2176
integer height = 176
...
type gb_2 from w_inheritance`gb_2 within w_iractio_new_m
integer x = 1330
integer y = 8
integer width = 2715
integer height = 212
...
type gb_1 from w_inheritance`gb_1 within w_iractio_new_m
integer x = 4763
integer y = 8
integer width = 1632
integer height = 212
...
type dw_2 from w_inheritance`dw_2 within w_iractio_new_m
integer x = 2615
integer y = 92
integer width = 1006
integer height = 84
...
string arg_loc_no, arg_yyyymm, ls_user_id, ls_magam_yn, ls_salesman
...
if MessageBox("확인", MidA(arg_yyyymm,1,4) + "년 " + MidA(arg_yyyymm,5,2) + " 월 실사재고를 현재고로 반영 하시겠습니까?", Exclamation!, OKCancel!, 2) = 1 then
	...
	DECLARE dt_silsa_itemstock_run procedure for dt_silsa_itemstock_man_run :arg_yyyymm, :ls_factory, :ls_salesman, :gs_userid using sqlca;
...
SELECT dateadd(day, -1, dateadd(month, 1, convert(datetime, :arg_yyyymm+'01') )) inaudit_date, 
	...
	FROM  silsa_itemstock a with(nolock) inner join financial_location b with(nolock) on a.loc_no = b.loc_no and b.area_name = :ls_factory 
 where a.yyyymm = :arg_yyyymm
	/* and a.loc_no = :ls_loc_no 	*/
	   and user_id = :ls_salesman
...
long backcolor = 79741120
string text = "▣ 재고조정불가: ①차이량있는데사유없는경우, ②실사재고(-)"
boolean focusrectangle = false
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_whlogin_c5"
boolean border = false
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
/*신규추가 로직 2019.11.25 jowonsuk 담당자 일괄변경 기능*/		
...
for ll_cnt = 1 to ll_row
	dw_1.object.user_id[ll_cnt] = ls_salesman
	dw_1.object.user_name[ll_cnt] = ls_user_name
	dw_1.object.save_date[ll_cnt] = string(gf_today() ,'yyyymmdd')							
	
next

messagebox('알림','변경이 완료되었습니다.')
end event
