...
type st_3 from statictext within w_cdavgcost_m
end type
type st_4 from statictext within w_cdavgcost_m
end type
...
this.Control[iCurrent+13]=this.cbx_edit
this.Control[iCurrent+14]=this.st_2
this.Control[iCurrent+15]=this.dw_4
this.Control[iCurrent+16]=this.st_horizontal1
...
this.Control[iCurrent+22]=this.em_price
...
ls_itemno    = dw_1.object.item_no[dw_1.getrow()]
ls_itemname  = dw_1.object.item_name[dw_1.getrow()]
ls_qa        = dw_3.object.item_name[dw_3.getrow()]
ls_uom       = dw_3.object.uom[dw_3.getrow()]
...
long textcolor = 128
long backcolor = 67108864
string text = "[거래처별 단가체크]에서 우측상단 데이터 사용"
boolean focusrectangle = false
end type
...
for ll_row = 1 to dw_3.rowcount()
	...
	if ls_chk = "Y" then
		...
		ls_itemname  = dw_3.object.item_name[ll_row]
...
long textcolor = 33554432
boolean sorted = false
string item[] = {"C 단가","B 단가","A 단가","S 단가","SS 단가","W 단가","유통","품명그룹","빈도"}
borderstyle borderstyle = stylelowered!
end type
...
for ll_row = 1 to dw_4.rowcount()
	choose case ddlb_1.text
		case "C 단가"
			dw_4.object.price_c[ll_row] = ld_price
		...
		case "유통"
			dw_4.object.price_dis[ll_row] = ld_price
...
long textcolor = 16711680
long backcolor = 67108864
string text = "※우측상단 추가는 왼쪽 상단창에서 더블클릭,"
boolean focusrectangle = false
end type
...
long textcolor = 16711680
long backcolor = 67108864
string text = "      하단 추가는 왼쪽 하단창에서 더블클릭"
boolean focusrectangle = false
end type
