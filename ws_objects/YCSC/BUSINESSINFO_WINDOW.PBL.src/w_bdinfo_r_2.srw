$PBExportHeader$w_bdinfo_r_2.srw
$PBExportComments$설계영업현황조회[2000/11/29,서재복]
forward
global type w_bdinfo_r_2 from w_inheritance
end type
type pb_insert2 from picturebutton within w_bdinfo_r_2
end type
type pb_delete2 from picturebutton within w_bdinfo_r_2
end type
type ddlb_1 from dropdownlistbox within w_bdinfo_r_2
end type
type st_1 from statictext within w_bdinfo_r_2
end type
type dw_4 from datawindow within w_bdinfo_r_2
end type
type pb_print2 from picturebutton within w_bdinfo_r_2
end type
type pb_print1 from picturebutton within w_bdinfo_r_2
end type
type dw_5 from datawindow within w_bdinfo_r_2
end type
type pb_print3 from picturebutton within w_bdinfo_r_2
end type
type st_2 from statictext within w_bdinfo_r_2
end type
type dw_3 from datawindow within w_bdinfo_r_2
end type
end forward

global type w_bdinfo_r_2 from w_inheritance
integer width = 3662
string title = "거래처별 현장진행상황조회(w_bdinfo_r_2)"
...
global w_bdinfo_r_2 w_bdinfo_r_2
...
type pb_save from w_inheritance`pb_save within w_bdinfo_r_2
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_r_2
boolean visible = false
integer x = 1490
integer y = 0
integer width = 110
...
type dw_2 from w_inheritance`dw_2 within w_bdinfo_r_2
integer x = 69
integer y = 284
integer width = 3493
...
type st_title from w_inheritance`st_title within w_bdinfo_r_2
integer width = 1545
integer textsize = -20
long textcolor = 1090519039
string text = "거래처별 현장 진행상황"
end type

type st_tips from w_inheritance`st_tips within w_bdinfo_r_2
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_r_2
boolean visible = false
integer x = 3858
integer y = 244
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_r_2
boolean visible = false
integer x = 3899
integer y = 92
boolean enabled = false
...
type pb_close from w_inheritance`pb_close within w_bdinfo_r_2
integer x = 3374
...
type pb_print from w_inheritance`pb_print within w_bdinfo_r_2
boolean visible = false
integer x = 4133
integer y = 352
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_r_2
boolean visible = false
integer x = 3954
integer y = 292
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_r_2
boolean visible = false
integer x = 4306
integer y = 124
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_r_2
boolean visible = false
integer x = 4334
integer y = 360
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_r_2
integer x = 2606
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_r_2
integer x = 37
integer y = 232
integer width = 3557
end type

type gb_2 from w_inheritance`gb_2 within w_bdinfo_r_2
boolean visible = false
integer x = 3808
integer y = 1208
integer width = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_r_2
integer x = 2565
integer width = 1024
end type
