$PBExportHeader$w_bdinfo_m_con.srw
$PBExportComments$설계영업진행관리[2001/01/18,서재복]
forward
global type w_bdinfo_m_con from w_inheritance
end type
type dw_plist from datawindow within w_bdinfo_m_con
end type
type pb_insert2 from picturebutton within w_bdinfo_m_con
end type
type pb_delete2 from picturebutton within w_bdinfo_m_con
end type
type gb_4 from groupbox within w_bdinfo_m_con
end type
type pb_print3 from picturebutton within w_bdinfo_m_con
end type
type dw_print5 from datawindow within w_bdinfo_m_con
end type
type tab_1 from tab within w_bdinfo_m_con
end type
...
type cb_wf_ret from commandbutton within w_bdinfo_m_con
end type
end forward
...
integer width = 4658
integer height = 2876
string title = "공사영업진행입력(w_bdinfo_m_sale)"
...
global w_bdinfo_m_con w_bdinfo_m_con
...
tab_1.tabpage_1.dw_3.getchild("bdinfodet_buildingman", idwc_custperson)
...
type pb_save from w_inheritance`pb_save within w_bdinfo_m_con
integer x = 3182
end type
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_m_con
...
type st_title from w_inheritance`st_title within w_bdinfo_m_con
integer y = 36
integer height = 164
integer textsize = -20
string text = "공사영업 진행입력"
end type

type st_tips from w_inheritance`st_tips within w_bdinfo_m_con
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_m_con
boolean visible = false
integer x = 4087
integer y = 64
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_m_con
boolean visible = false
integer x = 4233
integer y = 64
...
type pb_close from w_inheritance`pb_close within w_bdinfo_m_con
integer x = 3374
...
type pb_print from w_inheritance`pb_print within w_bdinfo_m_con
boolean visible = false
integer x = 3739
integer y = 64
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_m_con
boolean visible = false
integer x = 3927
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_m_con
integer x = 2990
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_m_con
integer x = 2798
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_m_con
integer x = 2414
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_m_con
string tag = "736"
integer x = 736
integer y = 216
integer width = 3154
...
type gb_2 from w_inheritance`gb_2 within w_bdinfo_m_con
boolean visible = false
integer x = 3749
integer y = 948
integer width = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_m_con
integer x = 2373
integer width = 1216
end type

type dw_2 from w_inheritance`dw_2 within w_bdinfo_m_con
integer x = 759
integer y = 268
integer width = 3109
integer height = 484
integer taborder = 60
string dataobject = "d_bdinfo_m_con"
...
string dataobject = "d_bdinfo_input_l_con"
...
if tab_1.tabpage_1.dw_3.getrow() > 0 then
	...
	gs_var2 = tab_1.tabpage_1.dw_3.object.bdinfodet_buildingcom[tab_1.tabpage_1.dw_3.getrow()]
...
integer taborder = 100
string title = "none"
string dataobject = "d_bdinfo_m2_con"
boolean border = false
boolean livescroll = true
end type
...
integer taborder = 130
string title = "none"
string dataobject = "d_bdinfodet2_item_m_con"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
integer taborder = 120
string title = "none"
string dataobject = "d_bdinfodet2_m_con"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
