...
type gb_6 from groupbox within w_osaroi_new_m
end type
type gb_5 from groupbox within w_osaroi_new_m
end type
...
type gb_4 from gb_3 within w_osaroi_new_m
end type
end forward
...
integer width = 4878
integer height = 2884
string title = "판매매출관리NEW(w_osaroi_new_m)"
...
public subroutine wf_ret ();//string ls_cust
...
this.Control[iCurrent+23]=this.cbx_source
...
event resize;call super::resize;dw_4.width  = this.width  - 1006
dw_4.height = this.height - 864

gb_4.height = this.height - 880
dw_3.height = this.height - 1104
