...
type st_2 from statictext within w_mpslituse_r
end type
type st_3 from statictext within w_mpslituse_r
end type
type st_4 from statictext within w_mpslituse_r
end type
type st_5 from statictext within w_mpslituse_r
end type
type dw_3 from datawindow within w_mpslituse_r
end type
type cbx_sum from checkbox within w_mpslituse_r
end type
type dw_4 from datawindow within w_mpslituse_r
end type
end forward
...
this.Control[iCurrent+28]=this.cbx_sum
this.Control[iCurrent+29]=this.dw_4
end on
...
string dataobject = "d_mpslituse_t30"
...
if rb_2.checked = true then	// 사내
   ls_work = "2"	
	...
	elseif is_flag = "S" then		// 스리팅
		...
		dw_3.retrieve( ld_start, ld_end, is_wc, ls_area )
	else									// 원코일
		dw_1.retrieve( ld_start, ld_end )
	end if
	
elseif rb_4.checked = true then	// 판매
   ls_work = "4"	
	dw_1.retrieve( ls_area, ld_start, ld_end, is_flag )	
	dw_4.retrieve( ls_area, ld_start, ld_end, is_flag )	
else
   ls_work = ""	// 외주, 잔량
	dw_1.retrieve( ld_start, ld_end )
	dw_3.reset()
...
integer height = 120
integer taborder = 40
string title = "d_mpslituse_wr2"
string dataobject = "d_mpslituse_wr"
...
event clicked;// 판매
dw_1.dataobject = 'd_mpslituse_t30'
...
CHOOSE CASE index
	CASE 1
		...
		rb_2.checked = true		// 사내
		rb_3.enabled = false		// 외주
		rb_4.enabled = false		// 판매
		rb_5.enabled = false		// 잔량
		ddlb_2.enabled = false	// 작업장
	...
	CASE 2
		...
		rb_2.checked = true		// 사내
		rb_3.enabled = true		// 외주
		rb_4.enabled = true		// 판매
		rb_5.enabled = false		// 잔량
		ddlb_2.enabled = false	// 작업장
	...
	CASE 3
		...
		rb_3.enabled = false		// 외주
		rb_4.enabled = true		// 판매
		rb_5.enabled = true		// 잔량
		ddlb_2.enabled = true	// 작업장
END CHOOSE
...
event selectionchanged;// 해당작업장의 이름(wc.work_name)을 정확히 ddlb_2에 넣어 줘야 한다.
CHOOSE CASE index
	CASE 1
		is_wc = "%"
	CASE ELSE
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_mpslituse_t11"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_mpslituse_t31"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
