...
string  ls_month, ls_chkout, ls_top_level
decimal lr_ym,  lr_ys, lr_mm, lr_ms,   lr_bm, lr_yb, lr_yy
long    ll_row, ll_cmon2,  ll_cmon14,  ll_row1, ll_col, l_toplevel
...
for ll_row = 1 to dw_2.rowcount()
   ...
   lr_bm = (lr_ym + lr_yy - lr_mm) - (lr_ys - lr_ms)    // 전월잔액
	...
	ls_top_level = dw_2.object.data[ll_row, 45]
	...
	dw_1.setitem(ll_row1, "rotate",  dw_2.object.data[ll_row, 48]) // 회전월 추가 	
	...
	dw_3.setitem(ll_row1, "rotate",  dw_2.object.data[ll_row, 48]) // 회전월 추가 
