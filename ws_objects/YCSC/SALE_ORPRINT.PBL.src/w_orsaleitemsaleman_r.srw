...
type st_3 from statictext within w_orsaleitemsaleman_r
end type
type st_2 from statictext within w_orsaleitemsaleman_r
end type
type ddlb_1 from dropdownlistbox within w_orsaleitemsaleman_r
end type
end forward
...
integer width = 4667
integer height = 2832
string title = "영업사원별 물품별 수주현황(w_orsaleitemsaleman_r)"
st_1 st_1
em_1 em_1
em_2 em_2
st_3 st_3
