$PBExportHeader$w_messenger_m.srw
$PBExportComments$사내메신저
forward 
global type w_messenger_m from window
end type
type st_3 from statictext within w_messenger_m
end type
type st_2 from statictext within w_messenger_m
end type
type pb_7 from picturebutton within w_messenger_m
end type
type st_1 from statictext within w_messenger_m
end type
type pb_6 from picturebutton within w_messenger_m
end type
type cbx_1 from checkbox within w_messenger_m
end type
type pb_5 from picturebutton within w_messenger_m
end type
type st_time from statictext within w_messenger_m
end type
type cb_12 from commandbutton within w_messenger_m
end type
type cb_11 from commandbutton within w_messenger_m
end type
type cb_filteroff from commandbutton within w_messenger_m
end type
type sle_value from singlelineedit within w_messenger_m
end type
type ddlb_2 from dropdownlistbox within w_messenger_m
end type
type st_9 from statictext within w_messenger_m
end type
type ddlb_col from dropdownlistbox within w_messenger_m
end type
type st_8 from statictext within w_messenger_m
end type
type cb_10 from commandbutton within w_messenger_m
end type
type pb_4 from picturebutton within w_messenger_m
end type
type pb_3 from picturebutton within w_messenger_m
end type
type pb_2 from picturebutton within w_messenger_m
end type
type pb_1 from picturebutton within w_messenger_m
end type
type dw_4 from datawindow within w_messenger_m
end type
type dw_3 from datawindow within w_messenger_m
end type
type dw_2 from datawindow within w_messenger_m
end type
type st_title from statictext within w_messenger_m
end type
type cbx_3 from checkbox within w_messenger_m
end type
type dw_1 from datawindow within w_messenger_m
end type
type cb_filteron from commandbutton within w_messenger_m
end type
type gb_1 from groupbox within w_messenger_m
end type
end forward
...
string title = "사내 메신저(w_messenger_m)"
...
global w_messenger_m w_messenger_m
...
if ls_sms = "Y" then
	...
	ls_id      = String(dw_3.object.id[1])         // ID
		...
		if ls_sms = "Y" then
			for ll_row = 1 to UpperBound(ls_phone)	
      		...
      		// GF_MMSSEND( as_userid, as_sendhp, as_recvhp, as_recvname, as_message )
					GF_MMSSEND( gs_userid, ls_sender, ls_recipient,  '수신처', ls_message )	
				end if
			next
		end if		
