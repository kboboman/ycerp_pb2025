...
type st_1 from statictext within w_iocoilsubuse_m
end type
...
tab_1.width  = this.width  - 110
tab_1.height = this.height - 500

dw3.width    = this.width  - 151
dw3.height   = this.height - 744
dw4.width    = this.width  - 151
dw4.height   = this.height - 744
...
if ret_dw.retrieve(gs_area, ls_supp, date(em_1.text), date(em_2.text)) < 1 then
...
event itemchanged;string ls_item, ls_uom, ls_name
long ll_row
datawindowchild ldwc_lot
