...
type cbx_hap from checkbox within w_oisalemando_r
end type
type cbx_haphd from checkbox within w_oisalemando_r
end type
end forward
...
this.Control[iCurrent+27]=this.cbx_hap
this.Control[iCurrent+28]=this.cbx_haphd
end on
