...
integer width = 3593
integer height = 1792
string title = "조업자재 거래처조회(w_cdbsuppmaster_r)"
em_1 em_1
st_1 st_1
dw_3 dw_3
st_2 st_2
...
dw_1.retrieve( gs_area, ls_supp, ll_year - 1 )
if dw_1.rowcount() < 1 then dw_1.insertrow( 0 )

dw_2.retrieve( gs_area, ls_supp, ll_year )
