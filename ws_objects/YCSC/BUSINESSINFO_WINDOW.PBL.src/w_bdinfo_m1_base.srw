$PBExportHeader$w_bdinfo_m1_base.srw
forward
global type w_bdinfo_m1_base from w_inheritance
end type
type pb_insert2 from picturebutton within w_bdinfo_m1_base
end type
type pb_delete2 from picturebutton within w_bdinfo_m1_base
end type
type pb_print3 from picturebutton within w_bdinfo_m1_base
end type
end forward
...
integer width = 2560
integer height = 1440
string title = "기초입력정보(w_bdinfo_m1_base)"
...
global w_bdinfo_m1_base w_bdinfo_m1_base
...
type pb_save from w_inheritance`pb_save within w_bdinfo_m1_base
integer x = 2085
end type
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_m1_base
...
type dw_2 from w_inheritance`dw_2 within w_bdinfo_m1_base
integer x = 50
integer width = 2427
integer height = 992
integer taborder = 60
...
//	case 'bdinfodet_constructiondate'
//		openWithParm(w_calendar, ls_date)
//		ls_date = message.stringparm
//		if ls_date <> 'N' then
//			this.object.bdinfodet_constructiondate[row] = datetime(date(ls_date))
//		end if
...
event dw_2::doubleclicked;call super::doubleclicked;string ls_date
...
type st_title from w_inheritance`st_title within w_bdinfo_m1_base
integer y = 36
integer width = 1189
integer height = 164
integer textsize = -20
...
type st_tips from w_inheritance`st_tips within w_bdinfo_m1_base
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_m1_base
boolean visible = false
integer x = 4087
integer y = 64
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_m1_base
boolean visible = false
integer x = 4233
integer y = 64
...
type pb_close from w_inheritance`pb_close within w_bdinfo_m1_base
integer x = 2277
...
type pb_print from w_inheritance`pb_print within w_bdinfo_m1_base
boolean visible = false
integer x = 3739
integer y = 64
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_m1_base
boolean visible = false
integer x = 3927
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_m1_base
integer x = 1893
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_m1_base
integer x = 1701
...
dw_2.object.bdinfodet_makedate[li_dw_2row] = gf_today() //date(gdt_today)
//decimal ld_seq_no
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_m1_base
integer x = 1509
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_m1_base
string tag = "736"
integer x = 32
integer y = 244
integer width = 2464
...
type gb_2 from w_inheritance`gb_2 within w_bdinfo_m1_base
boolean visible = false
integer x = 1367
integer y = 80
integer width = 96
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_m1_base
integer x = 1481
integer width = 1010
end type
