$PBExportHeader$w_osteamaroiweek_r.srw
$PBExportComments$월매출 실적집계 현황(주간)
forward
global type w_osteamaroiweek_r from w_inheritance
end type
type em_1 from editmask within w_osteamaroiweek_r
end type
type st_1 from statictext within w_osteamaroiweek_r
end type
type st_2 from statictext within w_osteamaroiweek_r
end type
type rb_1 from radiobutton within w_osteamaroiweek_r
end type
type rb_2 from radiobutton within w_osteamaroiweek_r
end type
type rb_3 from radiobutton within w_osteamaroiweek_r
end type
type rb_4 from radiobutton within w_osteamaroiweek_r
end type
type cbx_1 from checkbox within w_osteamaroiweek_r
end type
type pb_1 from picturebutton within w_osteamaroiweek_r
end type
type cbx_2 from checkbox within w_osteamaroiweek_r
end type
type gb_4 from groupbox within w_osteamaroiweek_r
end type
type gb_5 from groupbox within w_osteamaroiweek_r
end type
end forward
...
integer width = 5522
integer height = 2880
string title = "월매출 실적집계 현황(주간)(w_osteamaroiweek_r)"
string icon = "Hand!"
em_1 em_1
st_1 st_1
st_2 st_2
...
global w_osteamaroiweek_r w_osteamaroiweek_r

type variables
integer ii_month
end variables

on w_osteamaroiweek_r.create
int iCurrent
call super::create
...
type pb_save from w_inheritance`pb_save within w_osteamaroiweek_r
boolean visible = false
integer taborder = 70
end type

type dw_1 from w_inheritance`dw_1 within w_osteamaroiweek_r
integer x = 41
integer y = 340
integer width = 5399
integer height = 2356
...
string dataobject = "d_osteamaroiweek_t"
...
type dw_2 from w_inheritance`dw_2 within w_osteamaroiweek_r
integer x = 4453
integer y = 40
integer width = 201
integer height = 148
integer taborder = 80
string dataobject = "d_osteamaroiweek_r"
boolean vscrollbar = false
boolean livescroll = false
end type

type st_title from w_inheritance`st_title within w_osteamaroiweek_r
integer width = 1522
string text = "월매출 실적집계 현황(주간)"
end type

type st_tips from w_inheritance`st_tips within w_osteamaroiweek_r
end type

type pb_compute from w_inheritance`pb_compute within w_osteamaroiweek_r
boolean visible = false
integer x = 2679
integer y = 48
...
type pb_print_part from w_inheritance`pb_print_part within w_osteamaroiweek_r
boolean visible = false
integer taborder = 60
end type

type pb_close from w_inheritance`pb_close within w_osteamaroiweek_r
integer x = 4174
integer taborder = 50
end type
...
type pb_print from w_inheritance`pb_print within w_osteamaroiweek_r
integer x = 3982
integer taborder = 40
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_osteamaroiweek_r
boolean visible = false
end type

type pb_delete from w_inheritance`pb_delete within w_osteamaroiweek_r
boolean visible = false
end type

type pb_insert from w_inheritance`pb_insert within w_osteamaroiweek_r
boolean visible = false
integer taborder = 130
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_osteamaroiweek_r
...
SELECT top 1 dbo.UF_GETLASTDAY(convert(char(8),getdate(),112)) INTO :ls_edate FROM login;
...
if cbx_1.checked = true then	// 개별출력
	if rb_3.checked = true then	// 영업+채권
		dw_1.retrieve( ls_sdate, ls_edate, ls_yyyymm, ll_year, ll_month )
	else
		dw_1.retrieve( ls_sdate, ls_edate, ls_yyyymm, ll_year, ll_month )
	end if
else
...
type gb_3 from w_inheritance`gb_3 within w_osteamaroiweek_r
integer x = 2633
integer y = 12
integer width = 809
integer height = 204
...
type gb_2 from w_inheritance`gb_2 within w_osteamaroiweek_r
integer x = 23
integer y = 224
integer width = 5440
integer height = 2496
...
type gb_1 from w_inheritance`gb_1 within w_osteamaroiweek_r
integer x = 3570
integer width = 827
integer taborder = 0
integer weight = 400
