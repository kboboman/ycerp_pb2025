$PBExportHeader$w_inaudit_detail_r.srw
$PBExportComments$구매 일일마감 재고(재고관리/조원석)
forward
global type w_inaudit_detail_r from w_inheritance
end type
type dw_3 from datawindow within w_inaudit_detail_r
end type
type em_1 from editmask within w_inaudit_detail_r
end type
type ddlb_dwtitles from dropdownlistbox within w_inaudit_detail_r
end type
type st_4 from statictext within w_inaudit_detail_r
end type
type ddlb_op from dropdownlistbox within w_inaudit_detail_r
end type
type sle_value from singlelineedit within w_inaudit_detail_r
end type
type cb_1 from commandbutton within w_inaudit_detail_r
end type
type cb_2 from commandbutton within w_inaudit_detail_r
end type
type cb_3 from commandbutton within w_inaudit_detail_r
end type
type cb_5 from commandbutton within w_inaudit_detail_r
end type
type ddlb_fld from dropdownlistbox within w_inaudit_detail_r
end type
type st_7 from statictext within w_inaudit_detail_r
end type
type dw_area from datawindow within w_inaudit_detail_r
end type
type cbx_o08 from checkbox within w_inaudit_detail_r
end type
type cbx_o09 from checkbox within w_inaudit_detail_r
end type
type gb_4 from groupbox within w_inaudit_detail_r
end type
type gb_6 from groupbox within w_inaudit_detail_r
end type
type pb_1 from picturebutton within w_inaudit_detail_r
end type
type pb_multi from picturebutton within w_inaudit_detail_r
end type
type st_6 from statictext within w_inaudit_detail_r
end type
type dw_4 from datawindow within w_inaudit_detail_r
end type
type dw_5 from datawindow within w_inaudit_detail_r
end type
type st_3 from statictext within w_inaudit_detail_r
end type
type cbx_op from checkbox within w_inaudit_detail_r
end type
type dw_6 from datawindow within w_inaudit_detail_r
end type
type cbx_user from checkbox within w_inaudit_detail_r
end type
type cbx_all from checkbox within w_inaudit_detail_r
end type
type hpb_1 from hprogressbar within w_inaudit_detail_r
end type
type st_1 from statictext within w_inaudit_detail_r
end type
type ddlb_gubun from dropdownlistbox within w_inaudit_detail_r
end type
type cbx_cqty from checkbox within w_inaudit_detail_r
end type
type cbx_qoh from checkbox within w_inaudit_detail_r
end type
type cb_4 from commandbutton within w_inaudit_detail_r
end type
type st_2 from statictext within w_inaudit_detail_r
end type
type ddlb_grade from dropdownlistbox within w_inaudit_detail_r
end type
type em_2 from editmask within w_inaudit_detail_r
end type
type st_5 from statictext within w_inaudit_detail_r
end type
type cbx_sub from checkbox within w_inaudit_detail_r
end type
end forward
...
integer width = 4846
integer height = 2572
string title = "월수불현황관리(w_inaudit_detail_r)"
string icon = "Hand!"
dw_3 dw_3
em_1 em_1
...
global w_inaudit_detail_r w_inaudit_detail_r
         ...
         insert into item_stock (loc_no, item_no, qa, stock_date, before_qty, in_qty, out_qty, jaje_qty, intemp_qty, ret_qty, etc_qty, stock_qty, stock_m_qty, gab_qty,  sysdate )
                 (
						...
						(                              
										...
										where convert(char(10), dateadd(day, -1, dateadd(month, 1, convert(datetime,  ltrim(rtrim(yyyymm))+'01' ) ) ),121) =  :ls_date
										and close_yn = 'I'
...
this.Control[iCurrent+35]=this.ddlb_grade
this.Control[iCurrent+36]=this.em_2
this.Control[iCurrent+37]=this.st_5
this.Control[iCurrent+38]=this.cbx_sub
end on

on w_inaudit_detail_r.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.em_1)
...
type pb_save from w_inheritance`pb_save within w_inaudit_detail_r
...
type dw_1 from w_inheritance`dw_1 within w_inaudit_detail_r
integer x = 32
integer y = 432
integer width = 4718
integer height = 1920
integer taborder = 80
string dataobject = "d_inaudit_detail_r"
...
//		end if
//		
//		ls_locname = dw_1.object.저장소명[row]
//		ls_itemno = dw_1.object.물품코드[row]
//		ls_itemnm = dw_1.object.물품명[row]
//		ls_qa     = dw_1.object.규격[row]
//		
//		
//		dw_4.reset()
...
type st_title from w_inheritance`st_title within w_inaudit_detail_r
integer x = 41
integer y = 48
integer width = 1061
string text = "월수불현황관리"
...
type st_tips from w_inheritance`st_tips within w_inaudit_detail_r
end type

type pb_compute from w_inheritance`pb_compute within w_inaudit_detail_r
boolean visible = false
integer x = 4178
integer y = 252
integer height = 88
...
type pb_print_part from w_inheritance`pb_print_part within w_inaudit_detail_r
boolean visible = false
integer x = 3982
integer y = 252
integer height = 88
...
type pb_close from w_inheritance`pb_close within w_inaudit_detail_r
integer x = 4155
integer y = 76
...
type pb_print from w_inheritance`pb_print within w_inaudit_detail_r
integer x = 3968
integer y = 76
...
type pb_cancel from w_inheritance`pb_cancel within w_inaudit_detail_r
boolean visible = false
integer x = 4375
integer y = 252
integer height = 88
...
type pb_delete from w_inheritance`pb_delete within w_inaudit_detail_r
boolean visible = false
integer x = 4585
integer y = 76
...
type pb_insert from w_inheritance`pb_insert within w_inaudit_detail_r
boolean visible = false
integer x = 1353
integer y = 76
...
type pb_retrieve from w_inheritance`pb_retrieve within w_inaudit_detail_r
integer x = 3607
integer y = 76
...
string ls_area, ls_locno, ls_sdate, ls_year, ls_month, ls_defno, ls_mindate, ls_gubun, ls_grade, ls_edate
...
dw_1.retrieve( ls_gubun, ls_locno, ls_sdate, ls_edate)		// 현재고
...
type gb_3 from w_inheritance`gb_3 within w_inaudit_detail_r
integer x = 2519
integer y = 16
integer width = 1056
integer height = 232
...
type gb_2 from w_inheritance`gb_2 within w_inaudit_detail_r
integer x = 1225
integer y = 16
integer width = 1262
integer height = 232
...
type gb_1 from w_inheritance`gb_1 within w_inaudit_detail_r
integer x = 3584
integer y = 16
integer width = 791
integer height = 232
...
type dw_2 from w_inheritance`dw_2 within w_inaudit_detail_r
integer x = 1161
integer y = 28
integer width = 128
integer height = 80
