$PBExportHeader$w_oilabel_m.srw
$PBExportComments$물품라벨 발행관리(2018/07/05, 조원석)
forward
global type w_oilabel_m from w_inheritance
end type
type dw_3 from datawindow within w_oilabel_m
end type
type dw_4 from datawindow within w_oilabel_m
end type
type dw_5 from datawindow within w_oilabel_m
end type
type dw_area from datawindow within w_oilabel_m
end type
type cbx_2 from checkbox within w_oilabel_m
end type
type cbx_3 from checkbox within w_oilabel_m
end type
type cbx_4 from checkbox within w_oilabel_m
end type
type cbx_5 from checkbox within w_oilabel_m
end type
type gb_8 from groupbox within w_oilabel_m
end type
type gb_7 from groupbox within w_oilabel_m
end type
type em_1 from editmask within w_oilabel_m
end type
type st_vertical from u_splitbar_vertical within w_oilabel_m
end type
type st_horizontal from u_splitbar_horizontal within w_oilabel_m
end type
type st_4 from statictext within w_oilabel_m
end type
type st_5 from statictext within w_oilabel_m
end type
type st_6 from statictext within w_oilabel_m
end type
type ddlb_fld from dropdownlistbox within w_oilabel_m
end type
type ddlb_dwtitles from dropdownlistbox within w_oilabel_m
end type
type st_7 from statictext within w_oilabel_m
end type
type sle_value from singlelineedit within w_oilabel_m
end type
type cb_1 from commandbutton within w_oilabel_m
end type
type cb_2 from commandbutton within w_oilabel_m
end type
type cb_3 from commandbutton within w_oilabel_m
end type
type cb_5 from commandbutton within w_oilabel_m
end type
type st_left from statictext within w_oilabel_m
end type
type em_left from editmask within w_oilabel_m
end type
type st_9 from statictext within w_oilabel_m
end type
type em_top from editmask within w_oilabel_m
end type
type ddlb_op from dropdownlistbox within w_oilabel_m
end type
type em_3 from editmask within w_oilabel_m
end type
type st_2 from statictext within w_oilabel_m
end type
type em_4 from editmask within w_oilabel_m
end type
type cb_4 from commandbutton within w_oilabel_m
end type
type dw_6 from datawindow within w_oilabel_m
end type
type cbx_test from checkbox within w_oilabel_m
end type
type em_2 from editmask within w_oilabel_m
end type
type pb_sale_search from picturebutton within w_oilabel_m
end type
type cb_6 from commandbutton within w_oilabel_m
end type
type st_prt from statictext within w_oilabel_m
end type
type st_3 from statictext within w_oilabel_m
end type
type st_8 from statictext within w_oilabel_m
end type
type rb_1 from radiobutton within w_oilabel_m
end type
type rb_2 from radiobutton within w_oilabel_m
end type
type gb_6 from groupbox within w_oilabel_m
end type
type st_pick from structure within w_oilabel_m
end type
end forward
...
integer width = 6693
integer height = 2472
string title = "부속품라벨 출력관리(w_oilabel_m)"
dw_3 dw_3
dw_4 dw_4
dw_5 dw_5
dw_area dw_area
...
global w_oilabel_m w_oilabel_m
...
string is_locnosql, is_order_no, is_label_no, is_number, is_convert_req_date, is_issue_schedule
...
this.Control[iCurrent+38]=this.cb_6
this.Control[iCurrent+39]=this.st_prt
...
type pb_save from w_inheritance`pb_save within w_oilabel_m
...
type dw_1 from w_inheritance`dw_1 within w_oilabel_m
integer x = 3922
integer y = 436
integer width = 1728
integer height = 756
...
//					ld_qty = ld_issue_qty
//			end if
			/*2019.08.14 jowonsuk 신규로 반영 처음부터 주문수량으로 할지, 선정수량으로 할지 결정, 선정수량 선택시 주문수량 보다 많을때는 선택할 수 있도록 로직 변경  */
...
type st_title from w_inheritance`st_title within w_oilabel_m
integer x = 0
integer y = 0
integer width = 1175
integer height = 140
string text = "부속품 라벨 출력관리"
end type

type st_tips from w_inheritance`st_tips within w_oilabel_m
integer x = 270
integer y = 164
end type

type pb_compute from w_inheritance`pb_compute within w_oilabel_m
boolean visible = false
integer x = 5870
integer y = 796
...
type pb_print_part from w_inheritance`pb_print_part within w_oilabel_m
boolean visible = false
integer x = 2889
integer width = 238
integer taborder = 40
...
type pb_close from w_inheritance`pb_close within w_oilabel_m
integer x = 4631
integer y = 64
...
type pb_print from w_inheritance`pb_print within w_oilabel_m
integer x = 4434
integer y = 64
...
type pb_cancel from w_inheritance`pb_cancel within w_oilabel_m
integer x = 4242
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_oilabel_m
boolean visible = false
integer x = 4864
integer y = 68
...
type pb_insert from w_inheritance`pb_insert within w_oilabel_m
boolean visible = false
integer x = 3867
integer y = 68
...
type pb_retrieve from w_inheritance`pb_retrieve within w_oilabel_m
integer x = 4041
integer y = 64
integer taborder = 30
...
dw_3.Retrieve( ls_area, ls_accept, ls_cat, ls_sdate )
...
type gb_3 from w_inheritance`gb_3 within w_oilabel_m
integer x = 32
integer y = 240
integer width = 4119
integer height = 180
...
type gb_2 from w_inheritance`gb_2 within w_oilabel_m
integer x = 1211
integer y = 16
integer width = 923
integer height = 216
...
type gb_1 from w_inheritance`gb_1 within w_oilabel_m
integer x = 4009
integer y = 16
integer width = 846
integer height = 216
...
type dw_2 from w_inheritance`dw_2 within w_oilabel_m
integer x = 32
integer y = 1220
integer width = 3858
integer height = 1140
