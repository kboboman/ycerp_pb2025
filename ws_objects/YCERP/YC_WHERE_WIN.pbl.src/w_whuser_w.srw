...
type st_1 from statictext within w_whuser_w
end type
type cb_3 from commandbutton within w_whuser_w
end type
type cbx_2 from checkbox within w_whuser_w
end type
type cbx_1 from checkbox within w_whuser_w
end type
type cbx_3 from checkbox within w_whuser_w
end type
type st_2 from statictext within w_whuser_w
end type
...
type ln_1 from line within w_whuser_w
end type
end forward
...
//
string ls_area, ls_com, ls_wcno, ls_sdate, ls_edate, ls_userid, ls_insateam, ls_workname
long   ll_row, ll_find
date   ld_sfcdate

istr_where2 = Message.PowerObjectParm
ls_workname = istr_where2.str1[1]
...
///////////////////////////////////////////////////////////////
SELECT insa_team        INTO :ls_insateam FROM wc         WHERE work_name = :ls_workname;
...
dw_1.retrieve( ls_area, ls_wcno, ls_sdate, ls_edate )

// 기존작업자 표시하기
if w_mpsfcdayuser_m.dw_1.rowcount() > 0 then
	for ll_row = 1 to w_mpsfcdayuser_m.dw_1.rowcount()
		ls_userid = w_mpsfcdayuser_m.dw_1.object.user_id[ll_row]
...
integer taborder = 10
string title = "none"
string dataobject = "d_lineuser_s1"
