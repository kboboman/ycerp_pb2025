$PBExportHeader$w_icitemstock_new_m.srw
$PBExportComments$장기재고관리(2003/08/25, 이인호)
forward
global type w_icitemstock_new_m from w_inheritance
end type
type rb_1 from radiobutton within w_icitemstock_new_m
end type
type rb_2 from radiobutton within w_icitemstock_new_m
end type
type rb_3 from radiobutton within w_icitemstock_new_m
end type
type dw_3 from datawindow within w_icitemstock_new_m
end type
type dw_4 from datawindow within w_icitemstock_new_m
end type
type dw_5 from datawindow within w_icitemstock_new_m
end type
type pb_1 from picturebutton within w_icitemstock_new_m
end type
type em_1 from editmask within w_icitemstock_new_m
end type
type st_3 from statictext within w_icitemstock_new_m
end type
type ddlb_fld from dropdownlistbox within w_icitemstock_new_m
end type
type ddlb_dwtitles from dropdownlistbox within w_icitemstock_new_m
end type
type st_4 from statictext within w_icitemstock_new_m
end type
type ddlb_op from dropdownlistbox within w_icitemstock_new_m
end type
type sle_value from singlelineedit within w_icitemstock_new_m
end type
type cb_1 from commandbutton within w_icitemstock_new_m
end type
type cb_2 from commandbutton within w_icitemstock_new_m
end type
type cb_3 from commandbutton within w_icitemstock_new_m
end type
type cb_5 from commandbutton within w_icitemstock_new_m
end type
type cbx_all from checkbox within w_icitemstock_new_m
end type
type st_1 from statictext within w_icitemstock_new_m
end type
type st_2 from statictext within w_icitemstock_new_m
end type
type st_vertical from u_splitbar_vertical within w_icitemstock_new_m
end type
type st_horizontal from u_splitbar_horizontal within w_icitemstock_new_m
end type
type cb_10 from commandbutton within w_icitemstock_new_m
end type
type tab_1 from tab within w_icitemstock_new_m
end type
...
global w_icitemstock_new_m w_icitemstock_new_m
...
on w_icitemstock_new_m.destroy
call super::destroy
destroy(this.rb_1)
destroy(this.rb_2)
destroy(this.rb_3)
...
type pb_save from w_inheritance`pb_save within w_icitemstock_new_m
integer x = 3383
integer y = 76
integer taborder = 50
end type
...
type dw_1 from w_inheritance`dw_1 within w_icitemstock_new_m
integer x = 2373
integer y = 420
integer width = 3237
integer height = 496
...
//	dw_1.object.loc_qoh[ll_cnt]   = lstr_where.qty1[ll_row]
	dw_1.object.reason1[1]   = lstr_where.str5[1]			// 비고1
//	dw_1.object.reason[ll_cnt]    = lstr_where.str5[ll_row]			// 비고1 + 비고2 + 비고3	
...
type st_title from w_inheritance`st_title within w_icitemstock_new_m
integer x = 41
integer y = 28
integer width = 1024
integer height = 144
...
type st_tips from w_inheritance`st_tips within w_icitemstock_new_m
end type

type pb_compute from w_inheritance`pb_compute within w_icitemstock_new_m
...
type pb_print_part from w_inheritance`pb_print_part within w_icitemstock_new_m
boolean visible = false
integer x = 178
integer y = 188
integer width = 96
...
type pb_close from w_inheritance`pb_close within w_icitemstock_new_m
integer x = 3575
integer y = 76
...
type pb_print from w_inheritance`pb_print within w_icitemstock_new_m
integer x = 3191
integer y = 76
...
type pb_cancel from w_inheritance`pb_cancel within w_icitemstock_new_m
boolean visible = false
integer x = 283
integer y = 188
integer width = 96
...
type pb_delete from w_inheritance`pb_delete within w_icitemstock_new_m
integer x = 2999
integer y = 76
...
type pb_insert from w_inheritance`pb_insert within w_icitemstock_new_m
integer x = 2807
integer y = 76
...
type pb_retrieve from w_inheritance`pb_retrieve within w_icitemstock_new_m
integer x = 2615
integer y = 76
...
//dw_5.retrieve( ls_locno, ls_sdate )
...
type gb_3 from w_inheritance`gb_3 within w_icitemstock_new_m
integer x = 32
integer y = 252
integer width = 4169
integer height = 164
...
type gb_2 from w_inheritance`gb_2 within w_icitemstock_new_m
integer x = 1129
integer y = 16
integer width = 896
integer height = 232
...
type gb_1 from w_inheritance`gb_1 within w_icitemstock_new_m
integer x = 2048
integer y = 16
integer width = 1751
integer height = 232
...
type dw_2 from w_inheritance`dw_2 within w_icitemstock_new_m
boolean visible = false
integer x = 2683
integer y = 2072
integer width = 2395
...
tab_1.tabpage_1.dw_6.retrieve( ls_locno, ls_sdate, ls_item_no,  ls_qa)
end event
...
//	end if
	...
	dw_2.object.groupitem_item_name[ll_cnt] = trim(lstr_where.name[ll_row])
	dw_2.object.reason_code[ll_cnt] = "Y" // 기타
next
