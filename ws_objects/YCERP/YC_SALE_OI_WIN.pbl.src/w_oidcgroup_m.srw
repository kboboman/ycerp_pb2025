$PBExportHeader$w_oidcgroup_m.srw
$PBExportComments$매출할인 관리(다중)
forward
global type w_oidcgroup_m from w_inheritance
end type
type em_1 from editmask within w_oidcgroup_m
end type
type em_2 from editmask within w_oidcgroup_m
end type
type dw_3 from datawindow within w_oidcgroup_m
end type
type st_3 from statictext within w_oidcgroup_m
end type
type ddlb_fld from dropdownlistbox within w_oidcgroup_m
end type
type ddlb_dwtitles from dropdownlistbox within w_oidcgroup_m
end type
type st_4 from statictext within w_oidcgroup_m
end type
type sle_value from singlelineedit within w_oidcgroup_m
end type
type cb_1 from commandbutton within w_oidcgroup_m
end type
type cb_2 from commandbutton within w_oidcgroup_m
end type
type cb_3 from commandbutton within w_oidcgroup_m
end type
type cb_5 from commandbutton within w_oidcgroup_m
end type
type pb_1 from picturebutton within w_oidcgroup_m
end type
type st_1 from statictext within w_oidcgroup_m
end type
type cb_4 from commandbutton within w_oidcgroup_m
end type
type cbx_1 from checkbox within w_oidcgroup_m
end type
type cb_6 from commandbutton within w_oidcgroup_m
end type
type st_2 from statictext within w_oidcgroup_m
end type
type st_5 from statictext within w_oidcgroup_m
end type
type st_6 from statictext within w_oidcgroup_m
end type
type st_7 from statictext within w_oidcgroup_m
end type
type dw_4 from datawindow within w_oidcgroup_m
end type
type dw_6 from datawindow within w_oidcgroup_m
end type
type gb_4 from groupbox within w_oidcgroup_m
end type
type pb_add from picturebutton within w_oidcgroup_m
end type
type cbx_2 from checkbox within w_oidcgroup_m
end type
type dw_7 from datawindow within w_oidcgroup_m
end type
type dw_5 from datawindow within w_oidcgroup_m
end type
type pb_del from picturebutton within w_oidcgroup_m
end type
type rb_1 from radiobutton within w_oidcgroup_m
end type
type rb_2 from radiobutton within w_oidcgroup_m
end type
type rb_3 from radiobutton within w_oidcgroup_m
end type
type ddlb_op from dropdownlistbox within w_oidcgroup_m
end type
type tab_1 from tab within w_oidcgroup_m
end type
...
type gb_5 from groupbox within w_oidcgroup_m
end type
end forward
...
global w_oidcgroup_m w_oidcgroup_m

type variables
st_print i_print
string  is_user, is_row_name
...
public subroutine wf_print (datawindow arg_dw);datetime ld_date
dec      ld_amount
...
string	ls_app1,  ls_app2,  ls_app3,  ls_app4,  ls_app5,  ls_apph, ls_apph1, ls_apph2	// ID
string	ls_rank1, ls_rank2, ls_rank3, ls_rank4, ls_rank5, ls_rankh	, ls_rankh1, ls_rankh2 // 직위
string	ls_user1, ls_user2, ls_user3, ls_user4, ls_user5, ls_userh, ls_userh1, ls_userh2// 이름
...
for ll_row = 1 to dw_5.rowcount()
	...
	if ll_line = 0 then
		...
		ls_rankh      = dw_1.object.rankh[1]
		ls_userh      = dw_1.object.userh[1]
		ls_apph       = string(dw_1.object.dc_appdth[1],"mm/dd")
		
		ls_rankh1      = dw_1.object.rankh1[1]
		ls_userh1      = dw_1.object.userh1[1]
		ls_apph1       = string(dw_1.object.dc_appdth1[1],"mm/dd")		
		
		ls_rankh2      = dw_1.object.rankh2[1]
		ls_userh2      = dw_1.object.userh2[1]
		ls_apph2       = string(dw_1.object.dc_appdth2[1],"mm/dd")		
...
this.Control[iCurrent+29]=this.pb_del
...
this.Control[iCurrent+34]=this.tab_1
this.Control[iCurrent+35]=this.gb_5
end on

on w_oidcgroup_m.destroy
call super::destroy
destroy(this.em_1)
destroy(this.em_2)
destroy(this.dw_3)
...
type pb_save from w_inheritance`pb_save within w_oidcgroup_m
integer x = 4695
integer y = 60
integer taborder = 50
end type
...
// 품목: 매출에누리, 선수금공제(DC10) codemst 처리 
///////////////////////////////////////////////////////////////////
// 저장
...
string   ls_rem1, ls_rem2, ls_rem3, ls_rem4, ls_rem5, ls_dctype
...
if dw_5.rowcount() > 10 then /*10->20개 변경 jowonsuk */
	MessageBox("확인", "거래처10개 이상의 현장은 한번에 처리 안됩니다.",Stopsign!)
...
for ll_row = 1 to dw_5.rowcount()
	...
	if rb_1.checked = true then	// 매출할인
		if ls_dctype = "DC10" then
			MessageBox('확인','매출할인_유형(선수금공제) 오류입니다.',Stopsign!)
...
if wf_update2( dw_1, dw_5, "Y") = true then
	UPDATE DC_GROUP
	   SET dc_rem1 = :ls_rem1, dc_rem2 = :ls_rem2
		  , dc_rem3 = :ls_rem3, dc_rem4 = :ls_rem4, dc_rem5 = :ls_rem5
...
type dw_1 from w_inheritance`dw_1 within w_oidcgroup_m
integer x = 1701
integer y = 452
integer width = 3365
integer height = 1280
...
//		case "rank2", "rank3", "rank4", "userh"                2020-08-13 jowonsuk 주석처리
//		case "rank1", "rank2", "rank3", "rank4", "userh" /*2020-08-13 jowonsuk 테스트 */
		case "rank1", "rank2", "rank3", "rank4", "userh", "userh1" /*2021-11-17 jowonsuk */
			is_user  = dwo.name		// 결재라인 변경대상
			if MessageBox("확인","결재라인을 변경 하겠습니까?", Exclamation!, OKCancel!, 2) = 2 then
				RETURN
			else
				// 결재자 선택
				//tab_1.visible = true
...
ls_dctype = this.object.dc_type[rowcount]

choose case ls_dctype
	case "DC10"				// 선수금공제, 선수금,  "DC11"
		rb_2.checked = true		// 선수금공제
		
	case else
		rb_1.checked = true		// 매출할인		
end choose

end event

type st_title from w_inheritance`st_title within w_oidcgroup_m
integer x = 50
integer y = 40
integer width = 1568
...
type st_tips from w_inheritance`st_tips within w_oidcgroup_m
end type

type pb_compute from w_inheritance`pb_compute within w_oidcgroup_m
boolean visible = false
integer taborder = 60
end type

type pb_print_part from w_inheritance`pb_print_part within w_oidcgroup_m
boolean visible = false
integer x = 3205
integer taborder = 40
integer weight = 400
...
type pb_close from w_inheritance`pb_close within w_oidcgroup_m
integer x = 4896
integer y = 60
integer taborder = 30
end type
...
type pb_print from w_inheritance`pb_print within w_oidcgroup_m
integer x = 4489
integer y = 60
integer taborder = 20
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_oidcgroup_m
boolean visible = false
integer taborder = 100
end type

type pb_delete from w_inheritance`pb_delete within w_oidcgroup_m
integer x = 4073
integer y = 60
...
type pb_insert from w_inheritance`pb_insert within w_oidcgroup_m
integer x = 3867
integer y = 60
...
string   ls_message, ls_userchk											// 작성자
...
if rb_3.checked = true then		// 전체
	MessageBox("확인","작업구분을 선택 하시기 바랍니다.")
	RETURN
end if

if rb_2.checked = true then		// 선수금공제
	if MessageBox("확인", "선수금공제 작업입니다. 계속하시겠습니까?", Exclamation!, OKCancel!, 2) = 2 then
		RETURN
   end if		
	...
	dw_1.getchild("dc_type", idwc_type)
	idwc_type.setfilter( " item_cd <> 'DC10'" )		// 선수금공제 제외
	idwc_type.filter()	
end if
/////////////////////////////////////////////////////////////////////////
...
INTO 
	...
	:ls_rank5, :ls_app5, :ls_user5, :ls_userchk
FROM 
	salehp a LEFT OUTER JOIN login c1  on a.apply1 = c1.user_id
...
if rb_2.checked = true then
	...
	/*2018.11.8 jowonsuk 협조에 박수진과장 못 가져옴.매출할인(선수금공제)_결재자로 가져오게 되어 있는데 이 로직이 없음. 11.8일에 매출할인(선수금공제)_결재자로 박수진과장 등록  */	
	SELECT '협조', a.user_id, a.user_name
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인(선수금공제)_협조자' AND use_yn = 'Y');

	dw_1.object.userh[1]   		= ls_userh	// 화면
	dw_1.object.dc_apph[1] 		= ls_apph
	dw_1.object.dc_hyupuser[1] = ls_apph
	
	dw_6.object.rankh[1]       = ls_rankh	// 결재설명
	

	/*2021.11.17 jowonsuk 협조1 신규로 추가  */	
	SELECT '협조1', a.user_id, a.user_name
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인(선수금공제)_협조자1' AND use_yn = 'Y');
	
	dw_1.object.userh1[1]   		= ls_userh	// 화면
	dw_1.object.dc_apph1[1] 		= ls_apph
	dw_1.object.dc_hyupuser[1] = ls_apph
	...
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인(선수금공제)_협조자2' AND use_yn = 'Y');
	
	dw_1.object.userh2[1]   		= ls_userh	// 화면
	dw_1.object.dc_apph2[1] 		= ls_apph
	dw_1.object.dc_hyupuser[1]		= ls_apph
	...
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인_협조자' AND use_yn = 'Y');
	...
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인_협조자1' AND use_yn = 'Y');
	...
	INTO :ls_rankh,	:ls_apph, :ls_userh
	FROM login a
	WHERE user_id = (SELECT top 1 item_cd FROM codemst WHERE type = '매출할인_협조자2' AND use_yn = 'Y');
...
type pb_retrieve from w_inheritance`pb_retrieve within w_oidcgroup_m
integer x = 3662
integer y = 60
integer taborder = 10
end type
...
string ls_dctype, ls_sdate, ls_edate, ls_user3, ls_value
long   ll_row
...
ll_row   = dw_3.retrieve( ls_dctype, ls_sdate, ls_edate, ls_user3 )
if ll_row < 1 then 
...
type gb_3 from w_inheritance`gb_3 within w_oidcgroup_m
integer x = 2130
integer y = 12
integer width = 782
integer height = 216
...
type gb_2 from w_inheritance`gb_2 within w_oidcgroup_m
integer x = 37
integer y = 392
integer width = 5083
integer height = 2388
...
type gb_1 from w_inheritance`gb_1 within w_oidcgroup_m
integer x = 2930
integer width = 2190
integer height = 216
integer taborder = 0
...
type dw_2 from w_inheritance`dw_2 within w_oidcgroup_m
integer x = 64
integer y = 12
integer width = 128
integer height = 100
...
if ll_cnt > 0 then
	...
	if ls_flag = "1" then		// 수정시
		...
		dw_6.object.dc_remh.protect     = true		// 협조
	else								// 등록시
		dw_1.enabled = true
		dw_1.object.dc_date.protect     = false	// 출고일자
		...
		dw_6.object.dc_rem4.protect     = false	// 결재자4
		dw_6.object.dc_rem5.protect     = false	// 결재자5
		dw_6.object.dc_remh.protect     = false	// 협조
	end if
...
if isnull( ls_custno ) OR ls_custno = "" then
	...
	if dw_5.rowcount() > 10 then /*기존 10개 -> 20개 변경 2020.05.11 jowonsuk */
...
choose case is_user
	case "rank1"											/*2020-8-12 jowonsuk 테스트 추가 */
		...
		dw_1.object.dc_app1[1] = ls_userid			// 결재자 ID
		dw_6.object.rank1[1]   = ls_rank
	...
	case "rank5"
		...
		dw_1.object.dc_app5[1] = ls_userid			// 결재자 ID
		dw_6.object.rank5[1]   = ls_rank

	case "rankh", "userh"
		dw_1.object.rankh[1]   = ls_rank				// 결재자 직위
		dw_1.object.userh[1]   = ls_usernm			// 결재자 이름
		dw_1.object.dc_apph[1] = ls_userid			// 결재자 ID
	...
	case "rankh1", "userh1"
		...
		dw_1.object.dc_apph1[1] = ls_userid			// 결재자 ID
		
	case "rankh2", "userh2"
		dw_1.object.rankh2[1]   = ls_rank				// 결재자 직위
		dw_1.object.userh2[1]   = ls_usernm			// 결재자 이름
		dw_1.object.dc_apph2[1] = ls_userid			// 결재자 ID
end choose
...
for l_row = 1 to 5
	...
	dw_1.setItem(1, "dc_app"+string(l_row), tab_1.tabpage_1.dw_12.GetItemString(ll_row, "approval"+string(l_row), Primary!, True))	
next
