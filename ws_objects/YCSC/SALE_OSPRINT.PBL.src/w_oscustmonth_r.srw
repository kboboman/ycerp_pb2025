$PBExportHeader$w_oscustmonth_r.srw
$PBExportComments$거래처별 판매원장(1998/05/18, 성삼지)
forward
global type w_oscustmonth_r from w_inheritance
end type
type st_1 from statictext within w_oscustmonth_r
end type
type em_1 from editmask within w_oscustmonth_r
end type
type rb_1 from radiobutton within w_oscustmonth_r
end type
type rb_2 from radiobutton within w_oscustmonth_r
end type
type dw_3 from datawindow within w_oscustmonth_r
end type
type dw_4 from datawindow within w_oscustmonth_r
end type
type dw_5 from datawindow within w_oscustmonth_r
end type
type dw_6 from datawindow within w_oscustmonth_r
end type
type em_2 from editmask within w_oscustmonth_r
end type
type st_4 from statictext within w_oscustmonth_r
end type
type em_3 from editmask within w_oscustmonth_r
end type
end forward
...
integer width = 3657
integer height = 2140
string title = "거래처별 판매원장(w_oscustmonth_r)"
st_1 st_1
em_1 em_1
rb_1 rb_1
rb_2 rb_2
...
event resize;call super::resize;dw_5.width  = this.width  - 100
dw_5.height = this.height - 540


end event

type pb_save from w_inheritance`pb_save within w_oscustmonth_r
boolean visible = false
integer taborder = 120
end type

type dw_1 from w_inheritance`dw_1 within w_oscustmonth_r
integer x = 1426
integer y = 24
integer width = 64
integer height = 56
...
type dw_2 from w_inheritance`dw_2 within w_oscustmonth_r
integer x = 1509
integer y = 24
integer width = 64
integer height = 56
...
type st_title from w_inheritance`st_title within w_oscustmonth_r
integer y = 20
integer width = 1312
string text = "거래처별 판매원장"
end type

type st_tips from w_inheritance`st_tips within w_oscustmonth_r
end type

type pb_compute from w_inheritance`pb_compute within w_oscustmonth_r
boolean visible = false
integer taborder = 130
end type

type pb_print_part from w_inheritance`pb_print_part within w_oscustmonth_r
boolean visible = false
integer taborder = 110
end type

type pb_close from w_inheritance`pb_close within w_oscustmonth_r
integer x = 3360
integer y = 40
...
type pb_print from w_inheritance`pb_print within w_oscustmonth_r
integer x = 3168
integer y = 40
integer taborder = 60
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_oscustmonth_r
boolean visible = false
integer taborder = 140
end type

type pb_delete from w_inheritance`pb_delete within w_oscustmonth_r
boolean visible = false
integer taborder = 150
end type

type pb_insert from w_inheritance`pb_insert within w_oscustmonth_r
boolean visible = false
integer taborder = 160
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_oscustmonth_r
integer x = 2976
integer y = 40
integer taborder = 20
end type
...
st_print l_print
string ls_start_cust, ls_end_cust, ls_where, ls_sql, ls_cust_no, ls_date
...
if rb_1.checked = true then
   ls_where = " and aroiinv.delete_flag <> ~~'Y~~' and datepart(year, aroiinv.oi_date) = " + string(ll_year) + &
	           " and datepart(month, aroiinv.oi_date) = " + string(ll_month)  + &
   ...
   dw_2.modify(ls_sql)
   dw_2.retrieve()				  
   ls_where = " and aroivc.delete_key <> ~~'Y~~' and datepart(year, aroivc.oi_date) = " + string(ll_year) + &
	           " and datepart(month, aroivc.oi_date) = " + string(ll_month)  + &
						  " and customer.salesman like ~~'" + is_ret + "~~'"
...
type gb_3 from w_inheritance`gb_3 within w_oscustmonth_r
boolean visible = false
integer x = 69
integer y = 720
integer width = 713
...
type gb_2 from w_inheritance`gb_2 within w_oscustmonth_r
integer y = 208
integer width = 3557
integer height = 144
integer taborder = 0
...
type gb_1 from w_inheritance`gb_1 within w_oscustmonth_r
integer x = 2949
integer y = 4
integer width = 635
integer height = 196
