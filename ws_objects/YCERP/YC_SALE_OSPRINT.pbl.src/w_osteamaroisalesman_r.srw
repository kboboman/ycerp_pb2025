$PBExportHeader$w_osteamaroisalesman_r.srw
$PBExportComments$월매출 채권현황(직원별)
forward 
global type w_osteamaroisalesman_r from w_inheritance
end type
type em_1 from editmask within w_osteamaroisalesman_r
end type
type st_1 from statictext within w_osteamaroisalesman_r
end type
type st_2 from statictext within w_osteamaroisalesman_r
end type
type pb_1 from picturebutton within w_osteamaroisalesman_r
end type
type cbx_2 from checkbox within w_osteamaroisalesman_r
end type
type cbx_1 from checkbox within w_osteamaroisalesman_r
end type
type dw_3 from datawindow within w_osteamaroisalesman_r
end type
type st_3 from statictext within w_osteamaroisalesman_r
end type
end forward
...
integer width = 5522
integer height = 2840
string title = "월매출 채권현황(직원별)(w_osteamaroisalesman_r)"
string icon = "Hand!"
em_1 em_1
st_1 st_1
st_2 st_2
...
global w_osteamaroisalesman_r w_osteamaroisalesman_r

type variables
integer ii_month
end variables

on w_osteamaroisalesman_r.create
int iCurrent
call super::create
...
on w_osteamaroisalesman_r.destroy
call super::destroy
destroy(this.em_1)
destroy(this.st_1)
destroy(this.st_2)
...
type pb_save from w_inheritance`pb_save within w_osteamaroisalesman_r
boolean visible = false
integer taborder = 70
end type

type dw_1 from w_inheritance`dw_1 within w_osteamaroisalesman_r
integer x = 41
integer y = 340
integer width = 5399
integer height = 2356
...
string dataobject = "d_osteamaroisalesman_t"
...
type st_title from w_inheritance`st_title within w_osteamaroisalesman_r
integer width = 1522
string text = "월매출 채권현황(직원별)"
end type

type st_tips from w_inheritance`st_tips within w_osteamaroisalesman_r
end type

type pb_compute from w_inheritance`pb_compute within w_osteamaroisalesman_r
boolean visible = false
integer x = 2679
integer y = 48
...
type pb_print_part from w_inheritance`pb_print_part within w_osteamaroisalesman_r
boolean visible = false
integer taborder = 60
end type

type pb_close from w_inheritance`pb_close within w_osteamaroisalesman_r
integer x = 4174
integer taborder = 50
end type
...
type pb_print from w_inheritance`pb_print within w_osteamaroisalesman_r
integer x = 3982
integer taborder = 40
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_osteamaroisalesman_r
boolean visible = false
end type

type pb_delete from w_inheritance`pb_delete within w_osteamaroisalesman_r
boolean visible = false
end type

type pb_insert from w_inheritance`pb_insert within w_osteamaroisalesman_r
boolean visible = false
integer taborder = 130
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_osteamaroisalesman_r
integer x = 3598
integer taborder = 20
...
type gb_3 from w_inheritance`gb_3 within w_osteamaroisalesman_r
integer x = 2633
integer y = 12
integer width = 809
integer height = 204
...
type gb_2 from w_inheritance`gb_2 within w_osteamaroisalesman_r
integer x = 23
integer y = 224
integer width = 5440
integer height = 2496
...
type gb_1 from w_inheritance`gb_1 within w_osteamaroisalesman_r
integer x = 3570
integer width = 827
integer taborder = 0
integer weight = 400
...
type dw_2 from w_inheritance`dw_2 within w_osteamaroisalesman_r
integer x = 814
integer y = 8
integer width = 169
integer height = 120
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_osteamaroisalesman_sos"
