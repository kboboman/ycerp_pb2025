...
type em_p1top from editmask within w_barcode_coilmst_r
end type
type em_p1left from editmask within w_barcode_coilmst_r
end type
type cb_1 from commandbutton within w_barcode_coilmst_r
end type
type st_prt from statictext within w_barcode_coilmst_r
end type
...
//////////////////////////////////////////////////////////////////////////////
string ls_prt1, ls_p1left, ls_p1top
...
event resize;//
gb_1.width  = newwidth  - (41 * 2)

dw_1.width  = newwidth  - (41 * 2)
dw_1.height = newheight - dw_1.y - 41
...
for ll_row = 1 to dw_1.RowCount()
	...
	dw_2.modify("DataWindow.print.margin.left = " + ls_p1left + " " )
	dw_2.modify("DataWindow.print.margin.top  = " + ls_p1top + " "  )
	dw_2.Object.DataWindow.Printer      = ls_printer
