$PBExportHeader$w_oilabel_m1.srw
$PBExportComments$물품라벨 발행관리(2018/07/05, 조원석)
forward
global type w_oilabel_m1 from w_inheritance
end type
type dw_3 from datawindow within w_oilabel_m1
end type
type dw_4 from datawindow within w_oilabel_m1
end type
type dw_5 from datawindow within w_oilabel_m1
end type
type dw_area from datawindow within w_oilabel_m1
end type
type cbx_2 from checkbox within w_oilabel_m1
end type
type cbx_3 from checkbox within w_oilabel_m1
end type
type cbx_4 from checkbox within w_oilabel_m1
end type
type cbx_5 from checkbox within w_oilabel_m1
end type
type gb_8 from groupbox within w_oilabel_m1
end type
type gb_7 from groupbox within w_oilabel_m1
end type
type em_1 from editmask within w_oilabel_m1
end type
type st_vertical from u_splitbar_vertical within w_oilabel_m1
end type
type st_horizontal from u_splitbar_horizontal within w_oilabel_m1
end type
type st_4 from statictext within w_oilabel_m1
end type
type st_5 from statictext within w_oilabel_m1
end type
type st_6 from statictext within w_oilabel_m1
end type
type ddlb_fld from dropdownlistbox within w_oilabel_m1
end type
type ddlb_dwtitles from dropdownlistbox within w_oilabel_m1
end type
type st_7 from statictext within w_oilabel_m1
end type
type sle_value from singlelineedit within w_oilabel_m1
end type
type cb_1 from commandbutton within w_oilabel_m1
end type
type cb_2 from commandbutton within w_oilabel_m1
end type
type cb_3 from commandbutton within w_oilabel_m1
end type
type cb_5 from commandbutton within w_oilabel_m1
end type
type st_left from statictext within w_oilabel_m1
end type
type em_left from editmask within w_oilabel_m1
end type
type st_9 from statictext within w_oilabel_m1
end type
type em_top from editmask within w_oilabel_m1
end type
type ddlb_op from dropdownlistbox within w_oilabel_m1
end type
type em_3 from editmask within w_oilabel_m1
end type
type st_2 from statictext within w_oilabel_m1
end type
type em_4 from editmask within w_oilabel_m1
end type
type cb_4 from commandbutton within w_oilabel_m1
end type
type dw_6 from datawindow within w_oilabel_m1
end type
type ddlb_kind from dropdownlistbox within w_oilabel_m1
end type
type em_2 from editmask within w_oilabel_m1
end type
type pb_sale_search from picturebutton within w_oilabel_m1
end type
type dw_work_area from datawindow within w_oilabel_m1
end type
type st_1 from statictext within w_oilabel_m1
end type
type st_prt from statictext within w_oilabel_m1
end type
type cb_6 from commandbutton within w_oilabel_m1
end type
type st_3 from statictext within w_oilabel_m1
end type
type st_8 from statictext within w_oilabel_m1
end type
type cbx_1 from checkbox within w_oilabel_m1
end type
type gb_6 from groupbox within w_oilabel_m1
end type
type st_pick from structure within w_oilabel_m1
end type
end forward
...
ddlb_kind ddlb_kind
em_2 em_2
pb_sale_search pb_sale_search
dw_work_area dw_work_area
st_1 st_1
st_prt st_prt
cb_6 cb_6
st_3 st_3
...
global w_oilabel_m1 w_oilabel_m1
...
DECLARE label_print_cursor2 CURSOR FOR  
select   a.order_no,
		  isnull(d.area_name,'') cust_name,
		  isnull(e.loc_name,'') scene_desc,
		  a.label_no,
		  a.item_no, 
		  b.item_name,
		  a.qa, 
...
from    label_item a with(nolock) 
            inner join groupitem b with(nolock) on a.item_no  = b.item_no
            inner join ask_head c with(nolock) on rtrim(ltrim(a.order_no)) = c.ask_no
		 inner join location e with(nolock) ON c.ask_loc = e.loc_no		
            inner join area d with(nolock) on c.t_area = d.area_no
  where a.req_date    = :i_req_date
      and a.salesman  = :is_salesman
      and a.req_seq    = :i_req_seq
      and a.req_flag    = :is_req_flag
...
if is_issue_schedule = '물품이동' then 

		OPEN label_print_cursor2;
		
				FETCH label_print_cursor2 INTO :ls_order_no, :ls_cust_name, :ls_scene_name, :ls_label_no, :ls_item_no, :ls_item_name, :ls_qa, :l_issue_qty, :ls_color_name;
				...
				Do While sqlca.sqlcode = 0		  	
					...
					dw_5.setitem(1, 'color'   + string(ll_line,"00"), ls_color_name)			
							
					FETCH label_print_cursor2 INTO :ls_order_no, :ls_cust_name, :ls_scene_name, :ls_label_no, :ls_item_no, :ls_item_name, :ls_qa, :l_issue_qty, :ls_color_name;
				Loop
		
		CLOSE label_print_cursor2;	
...
ls_left = ProfileString("YCERP.INI","Qrcode","LEFT"," ")
ls_top = ProfileString("YCERP.INI","Qrcode","TOP"," ")
ls_prt = ProfileString("YCERP.INI","Qrcode","PRINT"," ")

if isnull(ls_left) OR ls_left = "" then ls_left = "0.000"
if isnull(ls_top)  OR ls_top  = "" then ls_top  = "0.000"
st_prt.text = trim(ls_prt)
...
dw_work_area.settransobject(sqlca)
dw_work_area.insertrow(0)  
dw_work_area.object.area[1] = '[전체]'
...
ddlb_kind.text = '출고의뢰 기준(소벤딩)'
is_cat = '출고의뢰'

em_2.enabled = false		
pb_sale_search.enabled = false

if gs_area = 'B0001'then
	em_2.text = "BD" + string(today(), "yyyymmdd") + "001"
elseif gs_area = 'T0001'then
	em_2.text = "TD" + string(today(), "yyyymmdd") + "001"
else
	em_2.text = "HD" + string(today(), "yyyymmdd") + "001"
end if
...
this.pb_sale_search=create pb_sale_search
this.dw_work_area=create dw_work_area
this.st_1=create st_1
this.st_prt=create st_prt
...
this.Control[iCurrent+35]=this.ddlb_kind
this.Control[iCurrent+36]=this.em_2
this.Control[iCurrent+37]=this.pb_sale_search
this.Control[iCurrent+38]=this.dw_work_area
this.Control[iCurrent+39]=this.st_1
this.Control[iCurrent+40]=this.st_prt
this.Control[iCurrent+41]=this.cb_6
this.Control[iCurrent+42]=this.st_3
this.Control[iCurrent+43]=this.st_8
this.Control[iCurrent+44]=this.cbx_1
this.Control[iCurrent+45]=this.gb_6
end on

on w_oilabel_m1.destroy
call super::destroy
destroy(this.dw_3)
destroy(this.dw_4)
destroy(this.dw_5)
...
destroy(this.em_2)
destroy(this.pb_sale_search)
destroy(this.dw_work_area)
destroy(this.st_1)
destroy(this.st_prt)
destroy(this.cb_6)
destroy(this.st_3)
...
type pb_save from w_inheritance`pb_save within w_oilabel_m1
...
type dw_1 from w_inheritance`dw_1 within w_oilabel_m1
integer x = 3922
integer y = 436
integer width = 1728
integer height = 756
integer taborder = 80
string dataobject = "d_oilabel_new_m"
...
///*2019.06.18 jowonsuk 로직 추가 */
//if ld_order_qty = 0 or isnull(ld_order_qty) then
//else
//	if ld_qty > ld_order_qty then		
//		Net = MessageBox("오류", '주문수량보다 더 큰 수량을 넣을 수 없습니다. 더 큰 수량을  등록하시겠습니까?', Exclamation!, OKCancel!, 2)
//		
//		if net = 1 then			
//		else
//			ld_qty = ld_order_qty	
...
//					ld_qty = ld_issue_qty
//			end if			
			/*2019.07.31 jowonsuk 로직 수정 선정수량이 주문수량보다 많을때 선택할 수 있음  */
			if isnull(ld_issue_qty) or ld_issue_qty  =0 then
					ld_qty = ld_order_qty - ld_rlse_qty
			else
					IF ld_issue_qty > ld_order_qty THEN
						Net = MessageBox("알림", STRING(ll_row) + '행은 주문수량 [' + STRING(INTEGER(ld_order_qty)) + ']보다 선정수량 [' + STRING(INTEGER(ld_issue_qty)) + ']이 더 큽니다. 주문수량으로 등록하시겠습니까?', Exclamation!, OKCancel!, 2)
...
type st_title from w_inheritance`st_title within w_oilabel_m1
integer x = 0
integer y = 0
integer width = 1120
integer height = 140
...
type st_tips from w_inheritance`st_tips within w_oilabel_m1
integer x = 270
integer y = 164
end type

type pb_compute from w_inheritance`pb_compute within w_oilabel_m1
boolean visible = false
integer x = 5728
integer y = 896
...
type pb_print_part from w_inheritance`pb_print_part within w_oilabel_m1
boolean visible = false
integer x = 2889
integer width = 238
integer taborder = 40
...
type pb_close from w_inheritance`pb_close within w_oilabel_m1
integer x = 5147
integer y = 64
...
type pb_print from w_inheritance`pb_print within w_oilabel_m1
integer x = 4951
integer y = 64
...
if isnull(i_sys_date) = false then		/*dw_2 에서 받아온 . i_sys_date */
	...
	for ll_row = 1 to dw_1.rowcount()
			...
			if dw_1.object.label_check[ll_row]	= 'Y' then
					...
					ls_color_name = dw_1.object.color_name[ll_row]
...
/*					ls_label_no = trim(string(i_req_date))+ trim(string(is_salesman,'0000000000'))+trim(string(i_req_seq,'00000'))+trim(string(i_seq,'00000'))+is_order_no + trim(string(l_label_no, '00000'))  */
					...
					insert into label_item (req_date,     salesman,       req_seq,     req_flag,      seq,     order_no,       seq_no,     label_no,      item_no,       qa,       issue_qty,    sys_date,		 print_group, print_group_seq, print_no, mpsorder_order, order_seq, color, use_yn)
											values   (:i_req_date, :is_salesman, :i_req_seq, :is_req_flag, :i_seq, :ls_order_no, :l_seq_no, :ls_label_no, :ls_item_no, :ls_qa, :l_issue_qty, :l_sys_date,		 :l_print_group, :l_print_group_seq, :l_print_no, null, null, :ls_color_name, 'N' );
	...
	dw_2.retrieve(i_req_date, is_salesman, i_req_seq, is_req_flag, i_seq, is_order_no)		
...
//				and a.sys_date  = :l_sys_date;
		if is_issue_schedule = '물품이동' then 
				...
				DECLARE label_item_test_cursor2 CURSOR FOR  
				/*select  a.print_group, a.label_no,  '\'+a.item_no+'\' + convert(nvarchar(60), b.item_name) +'\'+a.qa+'\'+convert(char(18), a.issue_qty )*/
				select  a.label_no+'|'+isnull(d.area_name,' ')+'|'+isnull(e.loc_name,' '), a.print_group, a.label_no,  '*'+convert(char(3),a.seq_no)+'|'+a.item_no+ '|'+a.qa+'|' , isnull(a.issue_qty,0) issue_qty
				from    label_item a with(nolock) 
									 inner join groupitem b with(nolock) on a.item_no  = b.item_no
									 inner join ask_head c with(nolock) on rtrim(ltrim(a.order_no)) = c.ask_no
									 inner join location e with(nolock) ON c.ask_loc = e.loc_no									 
				...
				for l_print_group = l_print_start_group to ll_cnt			 
						...
						OPEN label_item_test_cursor2;
						
								FETCH label_item_test_cursor2 INTO :l_base_data, :l_print_group, :ls_label_no, :ls_data, :l_req_qty;
				...
				/*select  a.print_group, a.label_no,  '\'+a.item_no+'\' + convert(nvarchar(60), b.item_name) +'\'+a.qa+'\'+convert(char(18), a.issue_qty )*/
				select  a.label_no+'|'+isnull(c.cust_no,' ')+'|'+isnull(c.scene_code,' '), a.print_group, a.label_no,  '*'+convert(char(3),a.seq_no)+'|'+a.item_no+ '|'+a.qa+'|' , isnull(a.issue_qty,0) issue_qty
				from    label_item a with(nolock) 
									 inner join groupitem b with(nolock) on a.item_no  = b.item_no
									 left outer join sale c with(nolock) on a.order_no = c.order_no
									 left outer join customer d with(nolock) on c.cust_no = d.cust_no
...
type pb_cancel from w_inheritance`pb_cancel within w_oilabel_m1
integer x = 4759
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_oilabel_m1
boolean visible = false
integer x = 5381
integer y = 68
...
type pb_insert from w_inheritance`pb_insert within w_oilabel_m1
boolean visible = false
integer x = 5623
integer y = 72
...
type pb_retrieve from w_inheritance`pb_retrieve within w_oilabel_m1
integer x = 4558
integer y = 64
integer taborder = 30
...
string ls_area, ls_sdate, ls_edate, ls_sale_no, ls_cat, ls_accept, ls_kind, ls_gubun[], ls_get, ls_sqlerrtext
long   l_row


DECLARE work_name_cursor CURSOR FOR  
                   select replace(replace(rtrim(ltrim(a.work_name)), '[', ''), ']', '') work_name
                   from
                   (
...
ls_kind = dw_work_area.object.area[1]

if ls_kind = '[전체]' then
	
		l_row = 0
	
		OPEN work_name_cursor;
		
			FETCH work_name_cursor INTO :ls_get;
		
			Do While sqlca.sqlcode = 0
		
				l_row = l_row + 1
				
				ls_gubun[l_row]  = ls_get;
			
				if sqlca.sqlcode < 0 then
					ls_sqlerrtext = string(sqlca.sqlerrtext)
					ROLLBACK;				
					MessageBox('오류32','[work_name_cursor] work_name_cursor DB오류가 발생했습니다.~r~n' + ls_sqlerrtext, exclamation!)
					RETURN 0
				end if					 
	...
	select  replace(replace(rtrim(ltrim(:ls_kind)), '[', ''), ']', '')
		into :ls_gubun[1]
	from dual;
...
//dw_3.dataobject = 'd_oilabel_new_r'
//dw_3.settransobject( sqlca)
...
dw_3.Retrieve( ls_area, ls_accept, is_cat, ls_sdate, ls_gubun )
...
type gb_3 from w_inheritance`gb_3 within w_oilabel_m1
integer x = 32
integer y = 240
integer width = 4119
integer height = 180
...
type gb_2 from w_inheritance`gb_2 within w_oilabel_m1
integer x = 1211
integer y = 16
integer width = 923
integer height = 216
...
type gb_1 from w_inheritance`gb_1 within w_oilabel_m1
integer x = 4526
integer y = 16
integer width = 846
integer height = 216
...
type dw_2 from w_inheritance`dw_2 within w_oilabel_m1
integer x = 32
integer y = 1220
integer width = 3858
integer height = 1140
integer taborder = 110
string dataobject = "d_oilabel_his_r1"
end type
...
string dataobject = "d_oilabel_new_r"
...
event clicked;long ll_row, l_len, l_row
string ls_gubun[], ls_kind, ls_get, ls_sqlerrtext
...
is_order_no = trim(this.object.order_no[row])
...
if is_issue_schedule = '물품이동' then  /* 출고의뢰에서 가지고 온다. */
	dw_1.dataobject = 'd_oilabel_new_m1'
	is_order_no =  is_order_no + '  '
else					   /* 물품이동에서 가져 온다. */
	dw_1.dataobject = 'd_oilabel_new_m'
end if 	
...
dw_1.retrieve(is_order_no, ls_gubun)
dw_2.retrieve(i_req_date, is_salesman, i_req_seq, is_req_flag, i_seq, is_order_no)
...
boolean bringtotop = true
boolean enabled = false
string title = "d_oilabel_printing"
string dataobject = "d_label_165x100_b01_new"
...
long textcolor = 33554432
boolean sorted = false
string item[] = {"출고의뢰 기준(소벤딩)","출고의뢰 기준(택배)","수주 기준(절곡,유압,상품)"}
borderstyle borderstyle = stylelowered!
end type
...
if this.text = '출고의뢰 기준(소벤딩)' then
		dw_3.dataobject = 'd_oilabel_new_r'
		is_cat = '출고의뢰'
		em_2.enabled = false		
		pb_sale_search.enabled = false
elseif 	this.text = '출고의뢰 기준(택배)' then
			dw_3.dataobject = 'd_oilabel_new_r'
			is_cat = '택배'
			em_2.enabled = false		
			pb_sale_search.enabled = false		
...
dw_3.dataobject = 'd_oilabel_new_r1'
dw_3.settransobject( sqlca)
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_whoilarea_s"
boolean border = false
boolean livescroll = true
end type
