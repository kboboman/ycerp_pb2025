$PBExportHeader$w_orsalesaleman_r2.srw
$PBExportComments$영업사원별 수주현황(1998/05/15, 정재수)
forward 
global type w_orsalesaleman_r2 from w_inheritance
end type
type st_1 from statictext within w_orsalesaleman_r2
end type
type em_1 from editmask within w_orsalesaleman_r2
end type
type em_2 from editmask within w_orsalesaleman_r2
end type
type st_2 from statictext within w_orsalesaleman_r2
end type
type dw_3 from datawindow within w_orsalesaleman_r2
end type
type dw_4 from datawindow within w_orsalesaleman_r2
end type
type st_4 from statictext within w_orsalesaleman_r2
end type
type cbx_1 from checkbox within w_orsalesaleman_r2
end type
type st_5 from statictext within w_orsalesaleman_r2
end type
type st_6 from statictext within w_orsalesaleman_r2
end type
type st_8 from statictext within w_orsalesaleman_r2
end type
type ddlb_fld from dropdownlistbox within w_orsalesaleman_r2
end type
type st_9 from statictext within w_orsalesaleman_r2
end type
type ddlb_op from dropdownlistbox within w_orsalesaleman_r2
end type
type sle_value from singlelineedit within w_orsalesaleman_r2
end type
type cb_filteron from commandbutton within w_orsalesaleman_r2
end type
type cb_filteroff from commandbutton within w_orsalesaleman_r2
end type
type cb_1 from commandbutton within w_orsalesaleman_r2
end type
type cb_2 from commandbutton within w_orsalesaleman_r2
end type
type gb_4 from groupbox within w_orsalesaleman_r2
end type
type ddlb_dwtitles from dropdownlistbox within w_orsalesaleman_r2
end type
end forward
...
integer width = 4119
integer height = 2324
string title = "수주접수 확인(w_orsalesaleman_r2)"
...
global w_orsalesaleman_r2 w_orsalesaleman_r2
...
this.Control[iCurrent+16]=this.cb_filteron
this.Control[iCurrent+17]=this.cb_filteroff
...
type pb_save from w_inheritance`pb_save within w_orsalesaleman_r2
integer x = 3186
integer y = 68
integer taborder = 90
end type
...
string ls_sale_control, ls_cust_chk, ls_order_chk, ls_orguser
int    li_seq 
...
type dw_1 from w_inheritance`dw_1 within w_orsalesaleman_r2
integer x = 32
integer y = 456
integer width = 4009
integer height = 1724
integer taborder = 0
string dataobject = "d_orsalesalemanrep_r2"
...
type st_title from w_inheritance`st_title within w_orsalesaleman_r2
integer x = 32
integer y = 28
integer width = 937
integer height = 136
...
type st_tips from w_inheritance`st_tips within w_orsalesaleman_r2
end type

type pb_compute from w_inheritance`pb_compute within w_orsalesaleman_r2
boolean visible = false
integer taborder = 100
end type

type pb_print_part from w_inheritance`pb_print_part within w_orsalesaleman_r2
boolean visible = false
integer taborder = 80
end type

type pb_close from w_inheritance`pb_close within w_orsalesaleman_r2
integer x = 3378
integer y = 68
integer taborder = 70
end type
...
type pb_print from w_inheritance`pb_print within w_orsalesaleman_r2
integer x = 2994
integer y = 68
integer taborder = 60
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_orsalesaleman_r2
boolean visible = false
end type

type pb_delete from w_inheritance`pb_delete within w_orsalesaleman_r2
boolean visible = false
end type

type pb_insert from w_inheritance`pb_insert within w_orsalesaleman_r2
boolean visible = false
integer taborder = 130
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_orsalesaleman_r2
integer x = 2802
integer y = 68
integer taborder = 40
end type
...
type gb_3 from w_inheritance`gb_3 within w_orsalesaleman_r2
integer x = 1038
integer y = 12
integer width = 1723
integer height = 224
...
type gb_2 from w_inheritance`gb_2 within w_orsalesaleman_r2
integer y = 256
integer width = 4009
integer height = 184
integer taborder = 0
...
type gb_1 from w_inheritance`gb_1 within w_orsalesaleman_r2
integer x = 2775
integer width = 818
integer height = 224
integer taborder = 0
...
type dw_2 from w_inheritance`dw_2 within w_orsalesaleman_r2
integer x = 50
integer y = 192
integer width = 82
integer height = 52
