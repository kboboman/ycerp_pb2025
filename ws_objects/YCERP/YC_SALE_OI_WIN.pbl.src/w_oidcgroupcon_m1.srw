$PBExportHeader$w_oidcgroupcon_m1.srw
$PBExportComments$매출할인 결재관리(거래처)
forward
global type w_oidcgroupcon_m1 from w_inheritance
end type
type em_1 from editmask within w_oidcgroupcon_m1
end type
type em_2 from editmask within w_oidcgroupcon_m1
end type
type dw_3 from datawindow within w_oidcgroupcon_m1
end type
type rb_topno from radiobutton within w_oidcgroupcon_m1
end type
type rb_topyes from radiobutton within w_oidcgroupcon_m1
end type
type st_3 from statictext within w_oidcgroupcon_m1
end type
type ddlb_fld from dropdownlistbox within w_oidcgroupcon_m1
end type
type ddlb_dwtitles from dropdownlistbox within w_oidcgroupcon_m1
end type
type st_4 from statictext within w_oidcgroupcon_m1
end type
type sle_value from singlelineedit within w_oidcgroupcon_m1
end type
type cb_1 from commandbutton within w_oidcgroupcon_m1
end type
type cb_2 from commandbutton within w_oidcgroupcon_m1
end type
type cb_3 from commandbutton within w_oidcgroupcon_m1
end type
type cb_5 from commandbutton within w_oidcgroupcon_m1
end type
type pb_1 from picturebutton within w_oidcgroupcon_m1
end type
type dw_dodet from datawindow within w_oidcgroupcon_m1
end type
type dw_do from datawindow within w_oidcgroupcon_m1
end type
type st_1 from statictext within w_oidcgroupcon_m1
end type
type rb_all from radiobutton within w_oidcgroupcon_m1
end type
type st_2 from statictext within w_oidcgroupcon_m1
end type
type cb_4 from commandbutton within w_oidcgroupcon_m1
end type
type st_5 from statictext within w_oidcgroupcon_m1
end type
type st_6 from statictext within w_oidcgroupcon_m1
end type
type rb_team from radiobutton within w_oidcgroupcon_m1
end type
type rb_area from radiobutton within w_oidcgroupcon_m1
end type
type cbx_1 from checkbox within w_oidcgroupcon_m1
end type
type dw_4 from datawindow within w_oidcgroupcon_m1
end type
type dw_5 from datawindow within w_oidcgroupcon_m1
end type
type dw_6 from datawindow within w_oidcgroupcon_m1
end type
type dw_7 from datawindow within w_oidcgroupcon_m1
end type
type cbx_2 from checkbox within w_oidcgroupcon_m1
end type
type rb_1 from radiobutton within w_oidcgroupcon_m1
end type
type rb_2 from radiobutton within w_oidcgroupcon_m1
end type
type rb_3 from radiobutton within w_oidcgroupcon_m1
end type
type rb_4 from radiobutton within w_oidcgroupcon_m1
end type
type dw_8 from datawindow within w_oidcgroupcon_m1
end type
type gb_4 from groupbox within w_oidcgroupcon_m1
end type
type gb_5 from groupbox within w_oidcgroupcon_m1
end type
type gb_6 from groupbox within w_oidcgroupcon_m1
end type
type dw_9 from datawindow within w_oidcgroupcon_m1
end type
type cb_bemat from commandbutton within w_oidcgroupcon_m1
end type
type ddlb_op from dropdownlistbox within w_oidcgroupcon_m1
end type
end forward
...
global w_oidcgroupcon_m1 w_oidcgroupcon_m1
...
public subroutine wf_move (datawindow arg_dw);// wf_move( arg_dw )
datetime ld_date
dec      ld_amount
...
for ll_row = 1 to dw_4.rowcount()
	...
	if ll_line = 0 then
      ...
      ls_hyupuser   = dw_4.object.userh[1]
		ls_hyupdt     = string(dw_4.object.dc_hyupdt[1],"mm/dd")
...
//
//// REMARK
//dw_9.y      = newheight - 694
//dw_9.width  = newwidth  - 1774
//dw_9.height = 704
//
//// DETAIL
//dw_8.width  = newwidth  - 1774
//dw_8.height = newheight - dw_1.y + dw_1.height + 704
//
end event

type pb_save from w_inheritance`pb_save within w_oidcgroupcon_m1
integer x = 4690
integer y = 60
integer taborder = 50
end type
...
string   ls_appdt1, ls_appdt2, ls_appdt3, ls_appdt4, ls_appdt5, ls_hyupdt
...
type dw_1 from w_inheritance`dw_1 within w_oidcgroupcon_m1
integer x = 1701
integer y = 452
integer width = 3365
integer height = 2296
...
string   ls_hyupuser, ls_hyupdt, ls_appdt5, ls_applydt
string   ls_dctype, ls_applyend, ls_applyend_save, ls_title, ls_dberror, ls_null
string   ls_invoice	// invoice_print = 'Y' 계산서 반영분
long     ll_row
decimal  ld_apply_amt, ld_totprice, ld_totamount
datetime ld_null, ld_applydt, ldt_date
...
ls_dctype   = this.object.dc_type[row]       // 할인유형(매출할인, 선수금공제, 선수금)
...
choose case dwo.name
	...
	case "user5", "p_rank5"
      ...
      //////////////////////////////////////////////////////////////////////////
		// [전결] 결재금액은 본부장 10만원, 팀장 5만원까지 결재가능
      //////////////////////////////////////////////////////////////////////////
		if ls_applyend = "매출할인_본부장" then
			if ld_totprice <= 100000 then	ls_applyend = "최종결재자"
		else
			if ls_applyend = "매출할인_팀장" then
				if ld_totprice <= 50000 then ls_applyend = "최종결재자"
			end if
		end if
      //////////////////////////////////////////////////////////////////////////		
...
type st_title from w_inheritance`st_title within w_oidcgroupcon_m1
integer x = 50
integer y = 40
integer width = 1632
...
type st_tips from w_inheritance`st_tips within w_oidcgroupcon_m1
end type

type pb_compute from w_inheritance`pb_compute within w_oidcgroupcon_m1
boolean visible = false
integer taborder = 60
end type

type pb_print_part from w_inheritance`pb_print_part within w_oidcgroupcon_m1
boolean visible = false
integer x = 3205
integer taborder = 40
integer weight = 400
...
type pb_close from w_inheritance`pb_close within w_oidcgroupcon_m1
integer x = 4896
integer y = 60
integer taborder = 30
end type
...
type pb_print from w_inheritance`pb_print within w_oidcgroupcon_m1
integer x = 4494
integer y = 60
integer taborder = 20
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_oidcgroupcon_m1
boolean visible = false
integer taborder = 100
end type

type pb_delete from w_inheritance`pb_delete within w_oidcgroupcon_m1
boolean visible = false
integer taborder = 110
end type

type pb_insert from w_inheritance`pb_insert within w_oidcgroupcon_m1
boolean visible = false
integer taborder = 120
end type

type pb_retrieve from w_inheritance`pb_retrieve within w_oidcgroupcon_m1
integer x = 4105
integer y = 60
integer taborder = 10
end type
...
type gb_3 from w_inheritance`gb_3 within w_oidcgroupcon_m1
integer x = 2222
integer y = 12
integer width = 658
integer height = 216
...
type gb_2 from w_inheritance`gb_2 within w_oidcgroupcon_m1
integer x = 37
integer y = 400
integer width = 5083
integer height = 2380
...
type gb_1 from w_inheritance`gb_1 within w_oidcgroupcon_m1
integer x = 3685
integer width = 1435
integer height = 216
integer taborder = 0
...
type dw_2 from w_inheritance`dw_2 within w_oidcgroupcon_m1
integer x = 443
integer y = 8
integer width = 128
integer height = 100
