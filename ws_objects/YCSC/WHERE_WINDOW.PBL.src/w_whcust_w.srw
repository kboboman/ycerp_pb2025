$PBExportHeader$w_whcust_w.srw
$PBExportComments$판매 코드 검색윈도우(1998/05/08, 성삼지)
forward
global type w_whcust_w from window
end type
type pb_2 from picturebutton within w_whcust_w
end type
type pb_1 from picturebutton within w_whcust_w
end type
type st_1 from statictext within w_whcust_w
end type
type em_2 from editmask within w_whcust_w
end type
type em_1 from editmask within w_whcust_w
end type
type rb_2 from radiobutton within w_whcust_w
end type
type rb_1 from radiobutton within w_whcust_w
end type
type gb_1 from groupbox within w_whcust_w
end type
end forward
...
global w_whcust_w w_whcust_w

type variables
gs_codere_str  ist_code
end variables

on w_whcust_w.create
