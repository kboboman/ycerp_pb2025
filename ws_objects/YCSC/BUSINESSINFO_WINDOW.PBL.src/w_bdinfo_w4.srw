$PBExportHeader$w_bdinfo_w4.srw
$PBExportComments$판매영업정보조회조건[2007/06/28,정갑용]
forward
global type w_bdinfo_w4 from window
end type
type st_18 from statictext within w_bdinfo_w4
end type
type dw_12 from datawindow within w_bdinfo_w4
end type
type dw_11 from datawindow within w_bdinfo_w4
end type
type st_b from statictext within w_bdinfo_w4
end type
type st_c from statictext within w_bdinfo_w4
end type
type st_d from statictext within w_bdinfo_w4
end type
type dw_10 from datawindow within w_bdinfo_w4
end type
type st_organ from statictext within w_bdinfo_w4
end type
type dw_9 from datawindow within w_bdinfo_w4
end type
type st_17 from statictext within w_bdinfo_w4
end type
type em_4 from editmask within w_bdinfo_w4
end type
type st_41 from statictext within w_bdinfo_w4
end type
type em_3 from editmask within w_bdinfo_w4
end type
type ddlb_expdate from dropdownlistbox within w_bdinfo_w4
end type
type st_16 from statictext within w_bdinfo_w4
end type
type st_15 from statictext within w_bdinfo_w4
end type
type st_14 from statictext within w_bdinfo_w4
end type
type st_13 from statictext within w_bdinfo_w4
end type
type st_12 from statictext within w_bdinfo_w4
end type
type st_11 from statictext within w_bdinfo_w4
end type
type ddlb_person from dropdownlistbox within w_bdinfo_w4
end type
type ddlb_div from dropdownlistbox within w_bdinfo_w4
end type
type st_10 from statictext within w_bdinfo_w4
end type
type dw_8 from datawindow within w_bdinfo_w4
end type
type st_9 from statictext within w_bdinfo_w4
end type
type dw_5 from datawindow within w_bdinfo_w4
end type
type st_8 from statictext within w_bdinfo_w4
end type
type dw_7 from datawindow within w_bdinfo_w4
end type
type dw_6 from datawindow within w_bdinfo_w4
end type
type st_7 from statictext within w_bdinfo_w4
end type
type st_6 from statictext within w_bdinfo_w4
end type
type sle_project from singlelineedit within w_bdinfo_w4
end type
type st_5 from statictext within w_bdinfo_w4
end type
type st_4 from statictext within w_bdinfo_w4
end type
type st_1 from statictext within w_bdinfo_w4
end type
type dw_3 from datawindow within w_bdinfo_w4
end type
type dw_2 from datawindow within w_bdinfo_w4
end type
type dw_1 from datawindow within w_bdinfo_w4
end type
type st_3 from statictext within w_bdinfo_w4
end type
type st_2 from statictext within w_bdinfo_w4
end type
type em_2 from editmask within w_bdinfo_w4
end type
type em_1 from editmask within w_bdinfo_w4
end type
type pb_2 from picturebutton within w_bdinfo_w4
end type
type pb_1 from picturebutton within w_bdinfo_w4
end type
type gb_1 from groupbox within w_bdinfo_w4
end type
end forward
...
global w_bdinfo_w4 w_bdinfo_w4
...
datawindowchild ldwc_dcd, ldwc_ccd, ldwc_bcd, ldwc_scd
...
ldwc_ccd.setitem(1,'comcode','%')
ldwc_ccd.setitem(1,'comname','전체')
//ldwc_ccd.accepttext()
...
dw_12.settransobject(sqlca)
dw_12.insertrow(0)
dw_12.getchild('s_code', ldwc_scd)
ldwc_scd.insertrow(1)
ldwc_scd.setitem(1,'comcode','%')
ldwc_scd.setitem(1,'comname','전체')
ldwc_scd.accepttext()
...
if trim(ist_where.str11) = '' then
	dw_11.object.c_code[1] = '%'
ELSE
	dw_11.object.c_code[1] = ist_where.str11
end if
if trim(ist_where.str12) = '' then
	dw_12.object.s_code[1] = '%'
ELSE
	dw_12.object.s_code[1] = ist_where.str12
end if
...
integer taborder = 40
string title = "none"
string dataobject = "d_building_s"
boolean border = false
end type
...
ist_where.str12 = dw_12.object.s_code[dw_12.getrow()]
