...
type st_vertical from u_splitbar_vertical within w_ocshipreq_m
end type
type st_horizontal from u_splitbar_horizontal within w_ocshipreq_m
end type
type st_2 from statictext within w_ocshipreq_m
end type
type ddlb_fld from dropdownlistbox within w_ocshipreq_m
end type
type ddlb_dwtitles from dropdownlistbox within w_ocshipreq_m
end type
type st_3 from statictext within w_ocshipreq_m
end type
type sle_value from singlelineedit within w_ocshipreq_m
end type
type cb_1 from commandbutton within w_ocshipreq_m
end type
type cb_2 from commandbutton within w_ocshipreq_m
end type
type cb_3 from commandbutton within w_ocshipreq_m
end type
type cb_5 from commandbutton within w_ocshipreq_m
end type
type ddlb_op from dropdownlistbox within w_ocshipreq_m
end type
type gb_4 from groupbox within w_ocshipreq_m
end type
end forward
