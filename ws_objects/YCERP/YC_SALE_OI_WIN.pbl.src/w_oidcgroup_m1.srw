$PBExportHeader$w_oidcgroup_m1.srw
$PBExportComments$매출할인 관리(다중)
forward
global type w_oidcgroup_m1 from w_inheritance
end type
type em_1 from editmask within w_oidcgroup_m1
end type
type em_2 from editmask within w_oidcgroup_m1
end type
type dw_3 from datawindow within w_oidcgroup_m1
end type
type st_3 from statictext within w_oidcgroup_m1
end type
type ddlb_fld from dropdownlistbox within w_oidcgroup_m1
end type
type ddlb_dwtitles from dropdownlistbox within w_oidcgroup_m1
end type
type st_4 from statictext within w_oidcgroup_m1
end type
type sle_value from singlelineedit within w_oidcgroup_m1
end type
type cb_1 from commandbutton within w_oidcgroup_m1
end type
type cb_2 from commandbutton within w_oidcgroup_m1
end type
type cb_3 from commandbutton within w_oidcgroup_m1
end type
type cb_5 from commandbutton within w_oidcgroup_m1
end type
type pb_1 from picturebutton within w_oidcgroup_m1
end type
type st_1 from statictext within w_oidcgroup_m1
end type
type cb_4 from commandbutton within w_oidcgroup_m1
end type
type cbx_1 from checkbox within w_oidcgroup_m1
end type
type cb_6 from commandbutton within w_oidcgroup_m1
end type
type st_2 from statictext within w_oidcgroup_m1
end type
type st_5 from statictext within w_oidcgroup_m1
end type
type st_6 from statictext within w_oidcgroup_m1
end type
type st_7 from statictext within w_oidcgroup_m1
end type
type dw_4 from datawindow within w_oidcgroup_m1
end type
type dw_6 from datawindow within w_oidcgroup_m1
end type
type gb_4 from groupbox within w_oidcgroup_m1
end type
type pb_add from picturebutton within w_oidcgroup_m1
end type
type cbx_2 from checkbox within w_oidcgroup_m1
end type
type dw_7 from datawindow within w_oidcgroup_m1
end type
type dw_5 from datawindow within w_oidcgroup_m1
end type
type tab_1 from tab within w_oidcgroup_m1
end type
...
type pb_del from picturebutton within w_oidcgroup_m1
end type
type rb_1 from radiobutton within w_oidcgroup_m1
end type
type rb_2 from radiobutton within w_oidcgroup_m1
end type
type rb_3 from radiobutton within w_oidcgroup_m1
end type
type ddlb_op from dropdownlistbox within w_oidcgroup_m1
end type
type gb_5 from groupbox within w_oidcgroup_m1
end type
end forward
...
global w_oidcgroup_m1 w_oidcgroup_m1
...
type pb_save from w_inheritance`pb_save within w_oidcgroup_m1
integer x = 4695
integer y = 60
integer taborder = 50
end type
...
type dw_1 from w_inheritance`dw_1 within w_oidcgroup_m1
integer x = 1701
integer y = 452
integer width = 3365
integer height = 1280
...
type st_title from w_inheritance`st_title within w_oidcgroup_m1
integer x = 50
integer y = 40
integer width = 1568
...
type st_tips from w_inheritance`st_tips within w_oidcgroup_m1
end type

type pb_compute from w_inheritance`pb_compute within w_oidcgroup_m1
boolean visible = false
integer taborder = 60
end type

type pb_print_part from w_inheritance`pb_print_part within w_oidcgroup_m1
boolean visible = false
integer x = 3205
integer taborder = 40
integer weight = 400
...
type pb_close from w_inheritance`pb_close within w_oidcgroup_m1
integer x = 4896
integer y = 60
integer taborder = 30
end type
...
type pb_print from w_inheritance`pb_print within w_oidcgroup_m1
integer x = 4489
integer y = 60
integer taborder = 20
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_oidcgroup_m1
boolean visible = false
integer taborder = 100
end type

type pb_delete from w_inheritance`pb_delete within w_oidcgroup_m1
integer x = 4073
integer y = 60
...
type pb_insert from w_inheritance`pb_insert within w_oidcgroup_m1
integer x = 3867
integer y = 60
...
if rb_2.checked = true then
	SELECT '승인', a.user_id, a.user_name
     INTO :ls_rankh,	:ls_apph, :ls_userh
	  FROM login a
	 WHERE user_id = (SELECT item_cd FROM codemst WHERE type = '매출할인(선수금공제)_결재자' AND use_yn = 'Y');

	//INTO :ls_rank5, :ls_app5, :ls_user5   
	ls_rank5 = ls_rank3		// 본부장 -> 최종결재자로 변경
	ls_app5  = ls_app3
	ls_user5 = ls_user3
...
type pb_retrieve from w_inheritance`pb_retrieve within w_oidcgroup_m1
integer x = 3662
integer y = 60
integer taborder = 10
end type
...
type gb_3 from w_inheritance`gb_3 within w_oidcgroup_m1
integer x = 2130
integer y = 12
integer width = 782
integer height = 216
...
type gb_2 from w_inheritance`gb_2 within w_oidcgroup_m1
integer x = 37
integer y = 392
integer width = 5083
integer height = 2388
...
type gb_1 from w_inheritance`gb_1 within w_oidcgroup_m1
integer x = 2930
integer width = 2190
integer height = 216
integer taborder = 0
...
type dw_2 from w_inheritance`dw_2 within w_oidcgroup_m1
integer x = 64
integer y = 12
integer width = 128
integer height = 100
