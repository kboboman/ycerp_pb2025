$PBExportHeader$w_line_b011.srw
$PBExportComments$생산라인 라벨출력(절곡)
forward 
global type w_line_b011 from window
end type
type cbx_3 from checkbox within w_line_b011
end type
type cbx_2 from checkbox within w_line_b011
end type
type em_copy from editmask within w_line_b011
end type
type st_7 from statictext within w_line_b011
end type
type em_prt from editmask within w_line_b011
end type
type st_4 from statictext within w_line_b011
end type
type cbx_1 from checkbox within w_line_b011
end type
type cbx_unit from checkbox within w_line_b011
end type
type cbx_next from checkbox within w_line_b011
end type
type em_top from editmask within w_line_b011
end type
type em_left from editmask within w_line_b011
end type
type st_6 from statictext within w_line_b011
end type
type st_5 from statictext within w_line_b011
end type
type st_key from statictext within w_line_b011
end type
type cb_3 from commandbutton within w_line_b011
end type
type cb_2 from commandbutton within w_line_b011
end type
type cb_1 from commandbutton within w_line_b011
end type
type st_2 from statictext within w_line_b011
end type
type dw_2 from datawindow within w_line_b011
end type
type st_1 from statictext within w_line_b011
end type
type dw_1 from datawindow within w_line_b011
end type
type st_3 from statictext within w_line_b011
end type
end forward
...
global w_line_b011 w_line_b011
...
VALUES (:ls_plan_no, :ls_wc_no, :ls_sale_no, :li_seq, :ls_item_no, :ls_qa,
	    ...
	    :ls_cust_no, :ls_cust_name, :ls_loc, :ls_scene_code, :ls_itemno_color,
...
VALUES (:ldt_sfc_dt,:ldt_date,:ls_assy_item,:ls_assy_qa,:ls_plan_no,:ldb_work_qty,0,:ls_loc,'RP',0,:ls_wc_no,"작업일보[YSP]");
if sqlca.sqlcode < 0 then
	ls_sqlerrtext = sqlca.sqlerrtext
	rollback;
...
event open;//
string  ls_packno, lsa_order_no[], lsa_item_name[], lsa_qa[]
...
dw_1.Object.DataWindow.Zoom = 110	// gl_resolution
...
cbx_unit.enabled = false 		// 계획수량=>작업수량 
