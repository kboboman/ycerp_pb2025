$PBExportHeader$w_bdinfo_w_2.srw
$PBExportComments$공사정보조회조건[2000/12/08,서재복]
forward
global type w_bdinfo_w_2 from window
end type
type cb_5 from commandbutton within w_bdinfo_w_2
end type
type cb_4 from commandbutton within w_bdinfo_w_2
end type
type cb_3 from commandbutton within w_bdinfo_w_2
end type
type cb_2 from commandbutton within w_bdinfo_w_2
end type
type dw_1 from datawindow within w_bdinfo_w_2
end type
type cb_1 from commandbutton within w_bdinfo_w_2
end type
type sle_1 from singlelineedit within w_bdinfo_w_2
end type
type pb_2 from picturebutton within w_bdinfo_w_2
end type
type pb_1 from picturebutton within w_bdinfo_w_2
end type
type gb_1 from groupbox within w_bdinfo_w_2
end type
end forward
...
string title = "현장명(공사명) 검색/등록(w_bdinfo_w_2)"
...
global w_bdinfo_w_2 w_bdinfo_w_2
...
event clicked;if dw_1.getrow() > 0 then
	ist_where.str2 = dw_1.object.bdinfodet_build_no[dw_1.getrow()]
	ist_where.dec1 = dw_1.object.bdinfodet_seq[dw_1.getrow()]
	ist_where.str1 = trim(dw_1.object.bdinfodet_project[dw_1.getrow()])
...
event clicked;long ll_dw1row, ll_seq
string ls_build_no

ll_dw1row = dw_1.getrow()
if messagebox('확인', trim(dw_1.object.bdinfodet_project[ll_dw1row]) + ' 을' + ' 삭제 하시겠습니까? ~n~n삭제시 현장정보 및 설계/공사/판매 입력자료가 같이(전체자료) 삭제되어 집니다.', question!, YesNo!, 1) = 1 then
...
integer taborder = 30
string title = "none"
string dataobject = "d_bdsearch_proj_s"
...
sle_1.text = this.object.bdinfodet_project[row]
