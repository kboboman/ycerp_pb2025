...
type gb_7 from groupbox within w_ocglbill_m
end type
type gb_6 from groupbox within w_ocglbill_m
end type
...
type st_8 from statictext within w_ocglbill_m
end type
type ddlb_col from dropdownlistbox within w_ocglbill_m
end type
type st_9 from statictext within w_ocglbill_m
end type
type ddlb_2 from dropdownlistbox within w_ocglbill_m
end type
type sle_value from singlelineedit within w_ocglbill_m
end type
type cb_filteron from commandbutton within w_ocglbill_m
end type
type cb_filteroff from commandbutton within w_ocglbill_m
end type
type cb_7 from commandbutton within w_ocglbill_m
end type
...
this.Control[iCurrent+27]=this.ddlb_dwtitles
end on
...
GF_DWTitle2ddlb( dw_3, ddlb_col, ddlb_dwtitles )
...
if this.getrow() > 0 then
	if gs_userid = '1999010s' or gs_userid = 'hanmr' or gs_userid = 'kgyoung'   or gs_userid = '19981214' then
...
event dw_1::itemchanged;call super::itemchanged;datetime ldt_null
...
event clicked;//
GF_DWClick2Info(this, ddlb_col, ddlb_2, sle_value, row, dwo.name, ddlb_dwtitles)
...
arg_dw  = dw_3
GF_DW2Filter(arg_dw, ddlb_col, ddlb_2, sle_value, ddlb_dwtitles)
...
GF_DW2Sort( arg_dw, ddlb_col, "A", ddlb_dwtitles )
...
GF_DW2Sort( arg_dw, ddlb_col, "D", ddlb_dwtitles )
