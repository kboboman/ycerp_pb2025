$PBExportHeader$w_bdinfo_m1_base3.srw
forward
global type w_bdinfo_m1_base3 from w_inheritance
end type
type pb_insert2 from picturebutton within w_bdinfo_m1_base3
end type
type pb_delete2 from picturebutton within w_bdinfo_m1_base3
end type
type pb_print3 from picturebutton within w_bdinfo_m1_base3
end type
type dw_3 from datawindow within w_bdinfo_m1_base3
end type
type dw_4 from datawindow within w_bdinfo_m1_base3
end type
end forward
...
global w_bdinfo_m1_base3 w_bdinfo_m1_base3
...
type pb_save from w_inheritance`pb_save within w_bdinfo_m1_base3
integer x = 3616
end type
...
type dw_1 from w_inheritance`dw_1 within w_bdinfo_m1_base3
...
type dw_2 from w_inheritance`dw_2 within w_bdinfo_m1_base3
integer x = 50
integer width = 3954
integer height = 992
integer taborder = 60
...
type st_title from w_inheritance`st_title within w_bdinfo_m1_base3
integer y = 36
integer width = 1189
integer height = 164
integer textsize = -20
...
type st_tips from w_inheritance`st_tips within w_bdinfo_m1_base3
end type

type pb_compute from w_inheritance`pb_compute within w_bdinfo_m1_base3
boolean visible = false
integer x = 4087
integer y = 64
...
type pb_print_part from w_inheritance`pb_print_part within w_bdinfo_m1_base3
boolean visible = false
integer x = 4233
integer y = 64
boolean enabled = false
...
type pb_close from w_inheritance`pb_close within w_bdinfo_m1_base3
integer x = 3808
...
type pb_print from w_inheritance`pb_print within w_bdinfo_m1_base3
boolean visible = false
integer x = 3739
integer y = 64
...
type pb_cancel from w_inheritance`pb_cancel within w_bdinfo_m1_base3
boolean visible = false
integer x = 3927
integer y = 64
...
type pb_delete from w_inheritance`pb_delete within w_bdinfo_m1_base3
integer x = 3424
...
type pb_insert from w_inheritance`pb_insert within w_bdinfo_m1_base3
integer x = 3232
...
type pb_retrieve from w_inheritance`pb_retrieve within w_bdinfo_m1_base3
integer x = 3040
integer taborder = 170
end type

event pb_retrieve::clicked;dw_2.retrieve(gl_var1)
...
type gb_3 from w_inheritance`gb_3 within w_bdinfo_m1_base3
string tag = "736"
integer x = 32
integer y = 244
integer width = 3995
...
type gb_2 from w_inheritance`gb_2 within w_bdinfo_m1_base3
integer x = 23
integer y = 1312
integer width = 4014
integer height = 512
...
type gb_1 from w_inheritance`gb_1 within w_bdinfo_m1_base3
integer x = 3013
integer width = 1010
end type
