$PBExportHeader$w_cdcon_m.srw
$PBExportComments$종건사(건설사) (2000/11/07,서재복)
forward
global type w_cdcon_m from w_inheritance
end type
type cb_1 from commandbutton within w_cdcon_m
end type
type cb_2 from commandbutton within w_cdcon_m
end type
type sle_1 from singlelineedit within w_cdcon_m
end type
type st_1 from statictext within w_cdcon_m
end type
end forward
...
type pb_save from w_inheritance`pb_save within w_cdcon_m
integer x = 3173
integer y = 68
end type
...
type dw_1 from w_inheritance`dw_1 within w_cdcon_m
integer x = 41
integer y = 308
integer width = 3520
integer height = 1600
...
type st_title from w_inheritance`st_title within w_cdcon_m
integer y = 36
integer width = 1138
integer height = 132
integer textsize = -20
...
type st_tips from w_inheritance`st_tips within w_cdcon_m
end type

type pb_compute from w_inheritance`pb_compute within w_cdcon_m
boolean visible = false
integer taborder = 90
end type

type pb_print_part from w_inheritance`pb_print_part within w_cdcon_m
boolean visible = false
end type

type pb_close from w_inheritance`pb_close within w_cdcon_m
integer x = 3365
integer y = 68
...
type pb_print from w_inheritance`pb_print within w_cdcon_m
integer x = 2981
integer y = 68
...
type pb_cancel from w_inheritance`pb_cancel within w_cdcon_m
boolean visible = false
integer taborder = 120
end type

type pb_delete from w_inheritance`pb_delete within w_cdcon_m
integer x = 2789
integer y = 68
...
type pb_insert from w_inheritance`pb_insert within w_cdcon_m
integer x = 2597
integer y = 68
...
type pb_retrieve from w_inheritance`pb_retrieve within w_cdcon_m
integer x = 2405
integer y = 68
...
type gb_3 from w_inheritance`gb_3 within w_cdcon_m
boolean visible = false
integer x = 32
integer y = 272
integer width = 2386
...
type gb_2 from w_inheritance`gb_2 within w_cdcon_m
integer x = 27
integer y = 260
integer width = 3557
integer height = 1668
...
type gb_1 from w_inheritance`gb_1 within w_cdcon_m
integer x = 2377
integer y = 28
integer width = 1202
long textcolor = 0
...
type dw_2 from w_inheritance`dw_2 within w_cdcon_m
boolean visible = false
integer x = 1211
integer y = 56
integer width = 187
