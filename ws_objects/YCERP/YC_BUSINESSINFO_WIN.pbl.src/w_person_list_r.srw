$PBExportHeader$w_person_list_r.srw
$PBExportComments$현장영업조회[조원석/2018/09/21]
forward
global type w_person_list_r from w_inheritance
end type
type pb_1 from picturebutton within w_person_list_r
end type
type pb_2 from picturebutton within w_person_list_r
end type
type st_3 from statictext within w_person_list_r
end type
type ddlb_fld from dropdownlistbox within w_person_list_r
end type
type ddlb_dwtitles from dropdownlistbox within w_person_list_r
end type
type st_4 from statictext within w_person_list_r
end type
type ddlb_op from dropdownlistbox within w_person_list_r
end type
type sle_value from singlelineedit within w_person_list_r
end type
type cb_2 from commandbutton within w_person_list_r
end type
type cb_3 from commandbutton within w_person_list_r
end type
type cb_4 from commandbutton within w_person_list_r
end type
type cb_5 from commandbutton within w_person_list_r
end type
type rb_1 from radiobutton within w_person_list_r
end type
type rb_2 from radiobutton within w_person_list_r
end type
type rb_3 from radiobutton within w_person_list_r
end type
type gb_4 from groupbox within w_person_list_r
end type
end forward
...
global w_person_list_r w_person_list_r
...
type pb_save from w_inheritance`pb_save within w_person_list_r
...
type dw_1 from w_inheritance`dw_1 within w_person_list_r
integer x = 37
integer y = 376
integer width = 4123
integer height = 1792
...
type st_title from w_inheritance`st_title within w_person_list_r
integer x = 55
integer y = 40
integer width = 1198
string text = "인맥 리스트"
...
type st_tips from w_inheritance`st_tips within w_person_list_r
end type

type pb_compute from w_inheritance`pb_compute within w_person_list_r
boolean visible = false
integer x = 2290
integer y = 0
integer width = 165
...
type pb_print_part from w_inheritance`pb_print_part within w_person_list_r
boolean visible = false
integer x = 1335
integer y = 8
integer taborder = 20
...
type pb_close from w_inheritance`pb_close within w_person_list_r
integer x = 4585
...
type pb_print from w_inheritance`pb_print within w_person_list_r
integer x = 4192
...
type pb_cancel from w_inheritance`pb_cancel within w_person_list_r
boolean visible = false
integer x = 1426
integer y = 68
...
type pb_delete from w_inheritance`pb_delete within w_person_list_r
boolean visible = false
integer x = 1477
integer y = 8
...
type pb_insert from w_inheritance`pb_insert within w_person_list_r
boolean visible = false
integer x = 1330
integer y = 84
...
type pb_retrieve from w_inheritance`pb_retrieve within w_person_list_r
integer x = 4000
...
type gb_3 from w_inheritance`gb_3 within w_person_list_r
boolean visible = false
integer x = 1787
integer y = 8
integer width = 407
...
type gb_2 from w_inheritance`gb_2 within w_person_list_r
boolean visible = false
integer x = 37
integer y = 216
integer width = 795
...
type gb_1 from w_inheritance`gb_1 within w_person_list_r
integer x = 3973
integer y = 8
integer width = 846
integer height = 208
...
type dw_2 from w_inheritance`dw_2 within w_person_list_r
boolean visible = false
integer x = 3040
integer y = 84
integer width = 841
