...
////프린트 용지를 프린트 Default로 한다.
ddlb_paper.SelectItem(1)
////출력물 확대/축소
//MessageBox('',ist_print.st_datawindow.Describe('DataWindow.Zoom'))
...
event clicked;//wf_printsetting()
ist_print.st_datawindow.Print()
pb_cancle.postevent(clicked!)
end event
...
ist_print.st_datawindow.Modify(ls_command)
//ist_print.dw.Modify(ls_command)
end event
...
event clicked;ist_print.st_datawindow.setredraw(false)
ist_print.st_datawindow.setredraw(true)
Close(Parent)
end event
...
string item[] = {"Default","A3","A4","A5","B4","B5","136칼럼"}
borderstyle borderstyle = stylelowered!
end type
