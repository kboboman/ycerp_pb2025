$PBExportHeader$w_cditemwcout_m.srw
$PBExportComments$제품별공정관리(외주)
forward 
global type w_cditemwcout_m from w_inheritance
end type
type gb_5 from gb_3 within w_cditemwcout_m
end type
type cb_1 from commandbutton within w_cditemwcout_m
end type
type dw_4 from datawindow within w_cditemwcout_m
end type
type dw_8 from datawindow within w_cditemwcout_m
end type
type dw_9 from datawindow within w_cditemwcout_m
end type
type dw_5 from datawindow within w_cditemwcout_m
end type
type pb_1 from picturebutton within w_cditemwcout_m
end type
type pb_2 from picturebutton within w_cditemwcout_m
end type
type dw_10 from datawindow within w_cditemwcout_m
end type
type pb_3 from picturebutton within w_cditemwcout_m
end type
type pb_4 from picturebutton within w_cditemwcout_m
end type
type dw_11 from datawindow within w_cditemwcout_m
end type
type dw_12 from datawindow within w_cditemwcout_m
end type
type sle_1 from singlelineedit within w_cditemwcout_m
end type
type cbx_bom from checkbox within w_cditemwcout_m
end type
type dw_6 from datawindow within w_cditemwcout_m
end type
type sle_2 from singlelineedit within w_cditemwcout_m
end type
type cb_2 from commandbutton within w_cditemwcout_m
end type
type st_work from statictext within w_cditemwcout_m
end type
type dw_3 from datawindow within w_cditemwcout_m
end type
type rb_1 from radiobutton within w_cditemwcout_m
end type
type rb_2 from radiobutton within w_cditemwcout_m
end type
type rb_3 from radiobutton within w_cditemwcout_m
end type
type rb_4 from radiobutton within w_cditemwcout_m
end type
type cb_3 from commandbutton within w_cditemwcout_m
end type
type cb_4 from commandbutton within w_cditemwcout_m
end type
type cb_5 from commandbutton within w_cditemwcout_m
end type
type pb_6 from picturebutton within w_cditemwcout_m
end type
type st_2 from statictext within w_cditemwcout_m
end type
type cbx_2 from checkbox within w_cditemwcout_m
end type
type st_3 from statictext within w_cditemwcout_m
end type
type pb_7 from picturebutton within w_cditemwcout_m
end type
type gb_6 from groupbox within w_cditemwcout_m
end type
type tv_1 from treeview within w_cditemwcout_m
end type
type cb_6 from commandbutton within w_cditemwcout_m
end type
type gb_4 from groupbox within w_cditemwcout_m
end type
end forward
...
global w_cditemwcout_m w_cditemwcout_m
...
event resize;call super::resize;// 품목그룹
dw_6.height = newheight - dw_6.y - dw_6.x

// 품목+규격
gb_2.width  = newwidth  - 2698
dw_1.width  = newwidth  - gb_3.x - dw_6.x
dw_1.height = newheight - 1384

// BOM조회
gb_4.x      = gb_2.x + gb_2.width + dw_6.x
gb_4.width  = newwidth  - gb_4.x - dw_6.x
cbx_bom.x   = gb_4.x    + 32
tv_1.x      = gb_4.x
tv_1.width  = gb_4.width
tv_1.height = dw_1.height

// 규격+작업장
gb_3.y      = dw_1.y + dw_1.height + 20
gb_3.width  = newwidth  - gb_3.x - dw_6.x
...
type pb_save from w_inheritance`pb_save within w_cditemwcout_m
integer x = 4635
integer y = 56
integer taborder = 90
end type
...
type dw_1 from w_inheritance`dw_1 within w_cditemwcout_m
integer x = 1445
integer y = 448
integer width = 2427
integer height = 1060
...
type st_title from w_inheritance`st_title within w_cditemwcout_m
integer x = 32
integer y = 32
integer width = 1266
integer height = 132
boolean enabled = true
string text = "제품별 공정관리(외주)"
end type

type st_tips from w_inheritance`st_tips within w_cditemwcout_m
end type

type pb_compute from w_inheritance`pb_compute within w_cditemwcout_m
boolean visible = false
integer taborder = 250
end type

type pb_print_part from w_inheritance`pb_print_part within w_cditemwcout_m
boolean visible = false
integer taborder = 230
end type

type pb_close from w_inheritance`pb_close within w_cditemwcout_m
integer x = 4827
integer y = 56
...
type pb_print from w_inheritance`pb_print within w_cditemwcout_m
integer x = 4443
integer y = 56
integer taborder = 80
end type
...
type pb_cancel from w_inheritance`pb_cancel within w_cditemwcout_m
integer x = 1733
integer y = 336
integer width = 320
integer height = 84
...
type pb_delete from w_inheritance`pb_delete within w_cditemwcout_m
integer x = 4251
integer y = 56
integer taborder = 20
end type
...
type pb_insert from w_inheritance`pb_insert within w_cditemwcout_m
integer x = 1769
integer y = 1584
integer width = 151
integer height = 108
...
type pb_retrieve from w_inheritance`pb_retrieve within w_cditemwcout_m
integer x = 4050
integer y = 56
...
type gb_3 from w_inheritance`gb_3 within w_cditemwcout_m
integer x = 1445
integer y = 1528
integer width = 3607
integer height = 184
...
type gb_2 from w_inheritance`gb_2 within w_cditemwcout_m
integer x = 1445
integer y = 280
integer width = 2427
integer height = 164
...
type gb_1 from w_inheritance`gb_1 within w_cditemwcout_m
integer x = 4023
integer y = 16
integer width = 1029
integer taborder = 0
...
type dw_2 from w_inheritance`dw_2 within w_cditemwcout_m
integer x = 1445
integer y = 1732
integer width = 3607
integer height = 612
integer taborder = 220
string dataobject = "d_cditemwcout_m"
borderstyle borderstyle = stylelowered!
end type
...
for i = 1 to dw_1.rowcount()	// 품목+규격
	...
	for j = 1 to dw_2.rowcount()		// 규격+작업장
		...
		if ll_chk = 0 then
			...
			if lb_chk = true then
				UPDATE rout 
				   SET wc_no = :ls_wcno, assembly = :ls_assembly, assy_qa = :ls_assyqa
			    WHERE item_no = :ls_itemno AND qa = :ls_qa1 AND operation = :li_op;
				if sqlca.sqlcode < 0 then
...
if cbx_bom.checked = true then
	...
	dw_1.width  = gb_2.width
else
	tv_1.bringtotop = false
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_cditemwcout_list"
...
event getfocus;////
//this.SelectText(1, len(this.text))		// 전체 선택
//
end event
...
long textcolor = 16711680
long backcolor = 67108864
string text = "공정일괄 처리대상을 먼저 CHK한 후 표준공정(품목+규격)을 마지막에 선택함."
boolean focusrectangle = false
end type
