...
type st_3 from statictext within w_mpsfcwc_r
end type
type ddlb_fld from dropdownlistbox within w_mpsfcwc_r
end type
type st_4 from statictext within w_mpsfcwc_r
end type
type ddlb_op from dropdownlistbox within w_mpsfcwc_r
end type
type sle_value from singlelineedit within w_mpsfcwc_r
end type
type cb_1 from commandbutton within w_mpsfcwc_r
end type
type cb_2 from commandbutton within w_mpsfcwc_r
end type
type cb_3 from commandbutton within w_mpsfcwc_r
end type
type cb_5 from commandbutton within w_mpsfcwc_r
end type
type gb_5 from groupbox within w_mpsfcwc_r
end type
type ddlb_dwtitles from dropdownlistbox within w_mpsfcwc_r
end type
type st_2 from statictext within w_mpsfcwc_r
end type
end forward
...
gb_5.width  = newwidth  - (32 * 2)

dw_3.width  = newwidth  - (32 * 2)
dw_3.height = newheight - dw_3.y - 32
...
long   ll_row
string ls_start, ls_end, ls_wcno, ls_area


ld_start = date(em_1.text)
ld_end   = date(em_2.text)		// RelativeDate( ld_start, 31)
...
if rb_1.checked = true then
	dw_3.retrieve(ls_wcno, ls_start, ls_end, ls_area)
else
	dw_3.retrieve(is_wcno, ld_start, ld_end, ls_area)
end if

dw_4.retrieve(is_wcno, ld_start, ld_end, ls_area)
