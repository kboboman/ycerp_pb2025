...
event pb_save::clicked;int    ll_count
...
//	if isnull(dw_1.object.groupitem[ll_count]) OR dw_1.object.groupitem[ll_count] <= "" THEN
//		MessageBox("입력오류", string(ll_count) + " 번째 몰딩명을 선택하십시오")
